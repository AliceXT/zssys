...
(1845, 'openid', 'openid', 'varchar(255) NOT NULL', 'string', '', '', 1, '', 214, 0, 1, 1442397273, 1442397273, '', 3, '', 'regex', '', 3, 'function'),
...
(448, 'token', 'Token', 'varchar(255) NOT NULL', 'string', '', '', 0, '', 64, 0, 1, 1437210667, 1396602859, '', 3, '', 'regex', 'get_token', 1, 'function'),
...
(1650, 'last_time', '物流最后更新时间', 'char(19) NOT NULL', 'string', '', '', 3, '', 190, 0, 1, 1439277451, 1439191158, '', 3, '', 'regex', '', 3, 'function'),
...
(666, 'name', '积分标识', 'varchar(50) NULL', 'string', '', '', 1, '', 87, 0, 1, 1445243577, 1396061947, '', 3, '', 'regex', '', 3, 'function'),
...
(774, 'token', 'Token', 'varchar(255) NOT NULL', 'string', '', '', 0, '', 88, 0, 1, 1437227332, 1400603451, '', 3, '', 'regex', 'get_token', 1, 'function'),
...
(1343, 'keyword', '关键词', 'varchar(100) NOT NULL', 'string', '', '', 1, '', 154, 1, 1, 1399038073, 1396061575, '', 3, '', 'regex', '', 3, 'function'),
(1344, 'title', '标题', 'varchar(255) NOT NULL', 'string', '', '', 1, '', 154, 1, 1, 1396624461, 1396061859, '', 3, '', 'regex', '', 3, 'function'),
(1345, 'intro', '封面简介', 'text NOT NULL', 'textarea', '', '', 1, '', 154, 0, 1, 1396624505, 1396061947, '', 3, '', 'regex', '', 3, 'function'),
(1346, 'mTime', '修改时间', 'int(10) NOT NULL', 'datetime', '', '', 0, '', 154, 0, 1, 1396624664, 1396624664, '', 3, '', 'regex', 'time', 3, 'function'),
(1347, 'cover', '封面图片', 'int(10) UNSIGNED NOT NULL', 'picture', '', '', 1, '', 154, 0, 1, 1396624534, 1396062093, '', 3, '', 'regex', '', 3, 'function'),
(1348, 'cTime', '发布时间', 'int(10) UNSIGNED NOT NULL', 'datetime', '', '', 0, '', 154, 0, 1, 1396624612, 1396075102, '', 3, '', 'regex', 'time', 1, 'function'),
(1349, 'token', 'Token', 'varchar(255) NOT NULL', 'string', '', '', 0, '', 154, 0, 1, 1396602871, 1396602859, '', 3, '', 'regex', 'get_token', 1, 'function'),
(1350, 'url', '访问网址', 'varchar(255) NOT NULL', 'string', '', '为空则自动生成', 0, '', 154, 0, 1, 1398416321, 1397361414, '', 3, '', 'regex', '', 3, 'function'),
(1351, 'is_close', '是否关闭', 'tinyint(2) NOT NULL', 'bool', '0', '关闭后用户不能再访问该页面', 1, '0:开启\r\n1:关闭', 154, 0, 1, 1397361841, 1397361510, '', 3, '', 'regex', '', 3, 'function'),
(1352, 'need_login', '游客访问', 'tinyint(2) NOT NULL', 'bool', '0', '', 1, '0:允许\r\n1:禁止', 154, 0, 1, 1397361769, 1397361769, '', 3, '', 'regex', '', 3, 'function'),
(1353, 'layout', '页面参数', 'text NOT NULL', 'textarea', '', '', 0, '', 154, 0, 1, 1397474846, 1397474846, '', 3, '', 'regex', '', 3, 'function'),
(1354, 'view_count', '浏览数', 'int(10) UNSIGNED NOT NULL', 'num', '0', '', 0, '', 154, 0, 1, 1397475862, 1397475862, '', 3, '', 'regex', '', 3, 'function'),
(1355, 'module', '模块名', 'varchar(255) NOT NULL', 'string', 'Diy', '页面所属的模块', 0, '', 154, 0, 1, 1398350642, 1398350642, '', 3, '', 'regex', '', 3, 'function'),
(1571, 'manager_deduct', '经理提成', 'varchar(255) NOT NULL', 'string', '', '经理提成', 1, '', 181, 0, 1, 1438871498, 1438868675, '', 3, '', 'regex', '', 3, 'function'),
(1570, 'partner_deduct', '合伙人总提成', 'varchar(255) NOT NULL', 'string', '', '合伙人总提成', 1, '', 181, 0, 1, 1438868485, 1438868485, '', 3, '', 'regex', '', 3, 'function'),
(1438, 'normalprice', '单价', 'varchar(255) NOT NULL', 'string', '', '', 1, '', 166, 0, 1, 1414466527, 1414136684, '', 3, '', 'regex', '', 3, 'function'),
(1439, 'pcount', '数量', 'varchar(255) NOT NULL', 'string', '', '', 1, '', 166, 0, 1, 1414136698, 1414136698, '', 3, '', 'regex', '', 3, 'function'),
(1440, 'token', 'Token值', 'varchar(255) NOT NULL', 'string', '', '', 0, '', 166, 0, 1, 1414136708, 1414136708, '', 3, '', 'regex', '', 3, 'function'),
(1434, 'read', '阅读量', 'int(10) UNSIGNED NOT NULL', 'num', '200', '', 0, '', 165, 0, 1, 1414490084, 1414488618, '', 3, '', 'regex', '', 3, 'function'),
(1435, 'addr', '送货地址', 'varchar(255) NOT NULL', 'string', '', '', 1, '', 166, 0, 1, 1414136618, 1414136618, '', 3, '', 'regex', '', 3, 'function'),
(1436, 'name', '商品名', 'varchar(255) NOT NULL', 'string', '', '', 1, '', 166, 0, 1, 1414136632, 1414136632, '', 3, '', 'regex', '', 3, 'function'),
(1437, 'odate', '下单时间', 'varchar(255) NOT NULL', 'string', '', '', 1, '', 166, 0, 1, 1414466437, 1414136669, '', 3, '', 'regex', '', 3, 'function'),
(1433, 'Recommend', '推荐', 'tinyint(2) NOT NULL', 'radio', '0', '', 1, '0:无\r\n1:推荐\r\n2:头条\r\n3:特荐', 165, 0, 1, 1414143299, 1414143035, '', 3, '', 'regex', '', 3, 'function'),
(1432, 'price', '原价', 'varchar(255) NOT NULL', 'string', '', '', 1, '', 165, 0, 1, 1414142867, 1414142867, '', 3, '', 'regex', '', 3, 'function'),
(1431, 'categoryid', '商品类别', 'char(50) NOT NULL', 'cascade', '', '', 1, '', 165, 0, 1, 1414137419, 1414121042, '', 3, '', 'regex', '', 3, 'function'),
(1430, 'token', 'Token值', 'varchar(255) NOT NULL', 'string', '', '', 0, '', 165, 0, 1, 1414121004, 1414121004, '', 3, '', 'regex', '', 3, 'function'),
(1429, 'pdate', '上柜日期', 'int(10) NOT NULL', 'datetime', '', '', 1, '', 165, 0, 1, 1414120988, 1414120988, '', 3, '', 'regex', 'time', 3, 'function'),
(1428, 'normalprice', '出售价格', 'varchar(255) NOT NULL', 'string', '', '', 1, '', 165, 0, 1, 1414120956, 1414120956, '', 3, '', 'regex', '', 3, 'function'),
(1580, 'token', 'token', 'varchar(255) NOT NULL', 'string', '', 'token', 1, '', 182, 0, 1, 1438876203, 1438876203, '', 3, '', 'regex', '', 3, 'function'),
(1579, 'fee', '费用', 'int(10) NOT NULL', 'num', '', '费用（单位：分）', 1, '', 182, 0, 1, 1438876188, 1438876188, '', 3, '', 'regex', '', 3, 'function'),
(1578, 'reason', '退货理由', 'int(10) NOT NULL', 'string', '', '退货理由', 1, '', 182, 0, 1, 1438935578, 1438876128, '', 3, '', 'regex', '', 3, 'function'),
(1577, 'oid', '订单id', 'int(10) NOT NULL', 'num', '', '订单id', 1, '', 182, 0, 1, 1438876091, 1438876091, '', 3, '', 'regex', '', 3, 'function'),
(1576, 'token', 'token', 'varchar(255) NOT NULL', 'string', '', 'token', 1, '', 181, 0, 1, 1438869725, 1438869725, '', 3, '', 'regex', '', 3, 'function'),
(1575, 'seller_credit', '销售员积分', 'int(10) NOT NULL', 'num', '', '销售员积分', 1, '', 181, 0, 1, 1438868954, 1438868954, '', 3, '', 'regex', '', 3, 'function'),
(1574, 'manager_credit', '经理积分', 'varchar(255) NOT NULL', 'num', '', '经理积分', 1, '', 181, 0, 1, 1438868968, 1438868905, '', 3, '', 'regex', '', 3, 'function'),
(1573, 'partner_credict', '合伙人积分', 'varchar(255) NOT NULL', 'num', '', '合伙人积分', 1, '', 181, 0, 1, 1438868979, 1438868844, '', 3, '', 'regex', '', 3, 'function'),
(1572, 'seller_deduct', '销售员提成', 'varchar(255) NOT NULL', 'string', '', '销售员提成', 1, '', 181, 0, 1, 1438868722, 1438868722, '', 3, '', 'regex', '', 3, 'function'),
(1427, 'desc', '描述', 'text NOT NULL', 'editor', '', '', 1, '', 165, 0, 1, 1414120933, 1414120933, '', 3, '', 'regex', '', 3, 'function'),
(1426, 'litpic', '商品展示图', 'int(10) UNSIGNED NOT NULL', 'picture', '', '', 1, '', 165, 0, 1, 1414120920, 1414120920, '', 3, '', 'regex', '', 3, 'function'),
(1425, 'name', '商品名', 'varchar(255) NOT NULL', 'string', '', '', 1, '', 165, 0, 1, 1414120908, 1414120908, '', 3, '', 'regex', '', 3, 'function'),
(1423, 'token', 'Token值', 'varchar(255) NOT NULL', 'string', '', '', 0, '', 164, 0, 1, 1414404095, 1414404095, '', 3, '', 'regex', '', 3, 'function'),
(1424, 'address', '收货地址', 'varchar(255) NOT NULL', 'string', '', '', 0, '', 164, 0, 1, 1414404111, 1414404111, '', 3, '', 'regex', '', 3, 'function'),
(1649, 'type', '快递公司', 'varchar(100) NOT NULL', 'select', '', '', 1, 'shunfeng:顺丰速运\r\nyunda:韵达快运\r\nyuantong:圆通速递\r\nshentong:申通快递\r\nzhongtong:中通速递\r\nhuitongkuaidi:汇通快运\r\nrufengda:如风达\r\nems:EMS快递\r\nzhongtiekuaiyun:中铁快运\r\nups:UPS快运\r\ndhl:DHL快运\r\nzhaijisong:宅急送\r\ntiantian:天天快递\r\nyouzhengguonei:邮政国内小包\r\naae:AAE全球专递\r\nanjie:安捷快递\r\nanxindakuaixi:安信达快递\r\nbiaojikuaidi:彪记快递\r\nbht:BHT\r\nbaifudongfang:百福东方国际物流\r\ncces:希伊艾斯快递\r\ncoe:中国东方（COE）\r\nchangyuwuliu:长宇物流\r\ndatianwuliu:大田物流\r\ndebangwuliu:德邦物流\r\ndpex:DPEX\r\ndsukuaidi:d速快递\r\ndisifang:递四方\r\nfedex:FEDEX（国外）\r\nfeikangda:飞康达物流\r\nfenghuangkuaidi:凤凰快递\r\nfeikuaida:飞快达\r\nnengda:港中能达物流\r\nguangdongyouzhengwuliu:广东邮政物流\r\ngongsuda:共速达\r\nguotongkuaidi:恒路物流\r\nhengluwuliu:华夏龙物流\r\nhuaxialongwuliu:海红\r\nhaihongwangsong:海外环球\r\njiayiwuliu:佳怡物流\r\njinguangsudikuaijian:京广速递\r\njixianda:急先达\r\njjwl:佳吉物流\r\njymwl:加运美物流\r\njindawuliu:金大物流\r\njialidatong:嘉里大通\r\njykd:晋越快递\r\nkuaijiesudi:快捷速递\r\nlianb:联邦快递（国内）\r\nlianhaowuliu:联昊通物流\r\nlongbanwuliu:龙邦物流\r\nlijisong:立即送\r\nlejiedi:乐捷递\r\nminghangkuaidi:民航快递\r\nmeiguokuaidi:美国快递\r\nmenduimen:门对门\r\nocs:OCS\r\npeisihuoyunkuaidi:配思货运\r\nquanchenkuaidi:全晨快递\r\nqfkd:全峰快递\r\nquanjitong:全际通物流\r\nquanritongkuaidi:全日通快递\r\nquanyikuaidi:全一快递\r\nsantaisudi:三态速递\r\nshenghuiwuliu:盛辉物流\r\nsuer:速尔物流\r\nshengfeng:盛丰物流\r\nsaiaodi:赛澳递\r\ntiandihuayu:天地华宇\r\ntnt:TNT\r\nwanjiawuliu:万家物流\r\nwenjiesudi:文捷航空速递\r\nwuyuan:伍圆\r\nwxwl:万象物流\r\nxinbangwuliu:新邦物流\r\nxinfengwuliu:信丰物流\r\nxingchenjibian:星晨急便\r\nyafengsudi:亚风速递\r\nyibangwuliu:一邦速递\r\nyoushuwuliu:优速物流\r\nyouzhengguoji:邮政国际包裹挂号信\r\nyuanchengwuliu:远成物流\r\nyuanweifeng:源伟丰快递\r\nyuanzhijiecheng:元智捷诚快递\r\nyuntongkuaidi:运通快递\r\nyuefengwuliu:越丰物流\r\nyuananda:源安达\r\nyinjiesudi:银捷速递\r\nzhongyouwuliu:中邮物流\r\nzhongxinda:忠信达\r\nzhimakaimen:芝麻开门\r\nguotongkuaidi:国通快递\r\n', 190, 1, 1, 1439275331, 1439190987, '', 3, '', 'regex', '', 3, 'function'),
(1648, 'f_openid', '上线openid', 'varchar(255) NOT NULL', 'string', '', '上线openid', 1, '', 177, 0, 1, 1439993748, 1439993748, '', 3, '', 'regex', '', 3, 'function'),
(1413, 'keyword', '关键词', 'varchar(100) NOT NULL', 'string', '', '', 1, '', 163, 1, 1, 1396624337, 1396061575, '', 3, '', 'regex', '', 3, 'function'),
(1414, 'keyword_type', '关键词类型', 'tinyint(2) NOT NULL', 'select', '0', '', 1, '0:完全匹配\r\n1:左边匹配\r\n2:右边匹配\r\n3:模糊匹配', 163, 1, 1, 1396624426, 1396061765, '', 3, '', 'regex', '', 3, 'function'),
(1415, 'title', '标题', 'varchar(255) NOT NULL', 'string', '', '', 1, '', 163, 1, 1, 1396624461, 1396061859, '', 3, '', 'regex', '', 3, 'function'),
(1416, 'intro', '封面简介', 'text NOT NULL', 'textarea', '', '', 1, '', 163, 0, 1, 1396624505, 1396061947, '', 3, '', 'regex', '', 3, 'function'),
(1417, 'mTime', '修改时间', 'int(10) NOT NULL', 'datetime', '', '', 0, '', 163, 0, 1, 1396624664, 1396624664, '', 3, '', 'regex', 'time', 3, 'function'),
(1418, 'cover', '封面图片', 'int(10) UNSIGNED NOT NULL', 'picture', '', '', 1, '', 163, 0, 1, 1396624534, 1396062093, '', 3, '', 'regex', '', 3, 'function'),
(1419, 'content', '内容', 'text NOT NULL', 'editor', '', '', 1, '', 163, 0, 1, 1396062146, 1396062146, '', 3, '', 'regex', '', 3, 'function'),
(1420, 'cTime', '发布时间', 'int(10) UNSIGNED NOT NULL', 'datetime', '', '', 0, '', 163, 0, 1, 1396624612, 1396075102, '', 3, '', 'regex', 'time', 1, 'function'),
(1421, 'token', 'Token', 'varchar(255) NOT NULL', 'string', '', '', 0, '', 163, 0, 1, 1396602871, 1396602859, '', 3, '', 'regex', 'get_token', 1, 'function'),
(1569, 'pid', '商品id', 'int(10) NOT NULL', 'num', '', '商品id', 1, '', 181, 0, 1, 1438868393, 1438868393, '', 3, '', 'regex', '', 3, 'function'),
(1643, 'title', '菜单名', 'varchar(50) NOT NULL', 'string', '', '可创建最多 3 个一级菜单，每个一级菜单下可创建最多 5 个二级菜单。编辑中的菜单不会马上被用户看到，请放心调试。', 1, '', 189, 0, 1, 1394519941, 1394518988, '', 3, '', 'regex', '', 3, 'function'),
(1647, 'icon', '图标', 'int(10) unsigned NULL ', 'picture', '', '根据选择的底部模板决定是否需要上传图标', 1, '', 189, 0, 1, 1396506297, 1396506297, '', 3, '', 'regex', '', 3, 'function'),
(1644, 'pid', '一级菜单', 'tinyint(2) NULL', 'select', '0', '如果是一级菜单，选择“无”即可', 1, '0:无', 189, 0, 1, 1394519296, 1394518930, '', 3, '', 'regex', '', 3, 'function'),
(1645, 'sort', '排序号', 'tinyint(4) NULL ', 'num', '0', '数值越小越靠前', 1, '', 189, 0, 1, 1394523288, 1394519175, '', 3, '', 'regex', '', 3, 'function'),
(1646, 'token', 'Token', 'varchar(255) NOT NULL', 'string', '', '', 0, '', 189, 0, 1, 1394526820, 1394526820, '', 3, '', 'regex', 'get_token', 1, 'function'),
(1636, 'cate_id', '商品分类', 'char(50) NOT NULL', 'cascade', '', '', 1, 'type=db&table=common_category&module=shop_category', 188, 0, 1, 1398693036, 1398599395, '', 3, '', 'regex', '', 3, 'function'),
(1637, 'bug_count', '成交量', 'int(10) unsigned NOT NULL ', 'num', '0', '', 0, '', 188, 0, 1, 1399002900, 1399002900, '', 3, '', 'regex', '', 3, 'function'),
(1638, 'stock_price', '进货价', 'int(10) NOT NULL', 'num', '', '进货价(单位:分)', 1, '', 188, 0, 1, 1438337222, 1438337222, '', 3, '', 'regex', '', 3, 'function'),
(1639, 'first_deduct', '一级代理提成', 'int(10) NOT NULL', 'num', '', '一级代理提成(单位:分)', 1, '', 188, 0, 1, 1438337442, 1438337442, '', 3, '', 'regex', '', 3, 'function'),
(1640, 'second_deduct', '二级代理提成', 'int(10) NOT NULL', 'num', '', '二级代理提成(单位:分)', 1, '', 188, 0, 1, 1438337578, 1438337578, '', 3, '', 'regex', '', 3, 'function'),
(1641, 'third_deduct', '三级代理提成', 'int(10) NOT NULL', 'num', '', '三级代理提成', 1, '', 188, 0, 1, 1438337675, 1438337675, '', 3, '', 'regex', '', 3, 'function'),
(1642, 'url', '关联URL', 'varchar(255) NULL ', 'string', '', '可用{site_url}代表当前网站根地址', 1, '', 189, 0, 1, 1399083504, 1394519090, '', 3, '', 'regex', '', 3, 'function'),
(1635, 'img_5', '商品图片5', 'int(10) unsigned NOT NULL ', 'picture', '', '', 1, '', 188, 0, 1, 1398598981, 1398598981, '', 3, '', 'regex', '', 3, 'function'),
(1634, 'img_4', '商品图片4', 'int(10) unsigned NOT NULL ', 'picture', '', '', 1, '', 188, 0, 1, 1398598960, 1398598960, '', 3, '', 'regex', '', 3, 'function'),
(1632, 'view_count', '浏览数', 'int(10) unsigned NOT NULL ', 'num', '0', '', 0, '', 188, 0, 1, 1397525660, 1397525660, '', 3, '', 'regex', '', 3, 'function'),
(1633, 'img_3', '商品图片3', 'int(10) unsigned NOT NULL ', 'picture', '', '', 1, '', 188, 0, 1, 1398598938, 1398598938, '', 3, '', 'regex', '', 3, 'function'),
(1631, 'discount_price', '打折价', 'int(10) unsigned NOT NULL ', 'num', '0', '为空时只显示市场价', 1, '', 188, 0, 1, 1397525579, 1397525579, '', 3, '', 'regex', '', 3, 'function'),
(1630, 'market_price', '市场价', 'int(10) unsigned NOT NULL ', 'num', '0', '', 1, '', 188, 0, 1, 1397525480, 1397525480, '', 3, '', 'regex', '', 3, 'function'),
(1628, 'cate_id_1', '商品一级分类', 'int(10) unsigned NOT NULL ', 'num', '0', '', 0, '', 188, 0, 1, 1397524477, 1397524433, '', 3, '', 'regex', '', 3, 'function'),
(1629, 'cate_id_2', '商品二级分类', 'int(10) unsigned NOT NULL ', 'num', '0', '', 0, '', 188, 0, 1, 1397524466, 1397524466, '', 3, '', 'regex', '', 3, 'function'),
(1626, 'ad_url', '商品广告页面', 'varchar(255) NOT NULL', 'string', '', '可为空，填写商品广告页面的地址', 1, '', 188, 0, 1, 1397521579, 1397521579, '', 3, '', 'regex', '', 3, 'function'),
(1542, 'status', '状态', 'int(50) NOT NULL', 'select', '0', '状态', 1, '0:待取现\r\n1:成功取现\r\n2:被拒绝', 179, 0, 1, 1438787066, 1438786444, '', 3, '', 'regex', '', 3, 'function'),
(1541, 'ctime', '申请取现时间', 'int(10) NOT NULL', 'datetime', '', '取现时间', 1, '', 179, 0, 1, 1447485570, 1438786355, '', 3, '', 'regex', '', 3, 'function'),
(1538, 'phone', '联系电话', 'varchar(255) NOT NULL', 'string', '', '联系电话', 1, '', 178, 0, 1, 1443508328, 1438874719, '', 3, '', 'regex', '', 3, 'function'),
(1627, 'buy_url', '购买地址', 'varchar(255) NOT NULL', 'string', '', '用户点击购买按钮时跳转的地址，可以是淘宝等网店的购买地址', 1, '', 188, 0, 1, 1397524287, 1397524287, '', 3, '', 'regex', '', 3, 'function'),
(1540, 'fee', '取现金额（分）', 'int(10) NOT NULL', 'num', '', '取现金额', 1, '', 179, 0, 1, 1438786323, 1438786323, '', 3, '', 'regex', '', 3, 'function'),
(1539, 'openid', 'openid', 'varchar(255) NOT NULL', 'string', '', 'openid', 1, '', 179, 0, 1, 1438786259, 1438786259, '', 3, '', 'regex', '', 3, 'function'),
(1537, 'address', '收件人地址', 'varchar(255) NOT NULL', 'string', '', '收件人地址', 1, '', 178, 0, 1, 1438874696, 1438874696, '', 3, '', 'regex', '', 3, 'function'),
(1536, 'receiver', '收件人', 'varchar(255) NOT NULL', 'string', '', '收件人', 1, '', 178, 0, 1, 1438874669, 1438874669, '', 3, '', 'regex', '', 3, 'function'),
(1528, 'user_id', '用户id', 'int(10) NOT NULL', 'num', '', '用户id', 1, '', 178, 1, 1, 1437698325, 1437698325, '', 3, '', 'regex', '', 3, 'function'),
(1527, 'timestamp', '下单时间', 'int(10) NOT NULL', 'date', '', '下单时间', 1, '', 178, 0, 1, 1437698570, 1437698570, '', 3, '', 'regex', '', 3, 'function'),
(1526, 'order_status', '订单状态', 'char(50) NOT NULL', 'select', '', '订单状态1.inorder,2.paied,3.returnGoods,4.agreereturn,', 1, '1:已下单，未付款\r\n2:已付款，未发货\r\n3:已经发货\r\n4:取消订单\r\n5:申请退货\r\n6:同意退货\r\n7:已确认收货\r\n8:拒绝退货\r\n9:已退款\r\n10:自提', 178, 0, 1, 1441618657, 1437698629, '', 3, '', 'regex', '', 3, 'function'),
(1521, 'token', 'token', 'varchar(255) NOT NULL', 'string', '', 'token', 0, '', 177, 0, 1, 1445063995, 1438910217, '', 3, '', 'regex', '', 3, 'function'),
(1518, 'manager_openid', '一级分销', 'varchar(255) NOT NULL', 'string', '', '', 0, '', 177, 0, 1, 1445064051, 1438673441, '', 3, '', 'regex', '', 3, 'function'),
(1625, 'param', '商品参数', 'text NOT NULL', 'editor', '', '', 1, '', 188, 0, 1, 1397521446, 1397521446, '', 3, '', 'regex', '', 3, 'function'),
(1622, 'content', '商品详情', 'text NOT NULL', 'editor', '', '', 0, '', 188, 0, 1, 1440388741, 1396062146, '', 3, '', 'regex', '', 3, 'function'),
(1535, 'by_from_openid', '购买的上线openid', 'varchar(255) NOT NULL', 'string', '', '购买的上线openid', 0, '', 178, 0, 1, 1438778837, 1438778837, '', 3, '', 'regex', '', 3, 'function'),
(1534, 'settle_status', '分销结算状态', 'int(50) NOT NULL', 'select', '0', '分销结算状态', 1, '0:未结算\r\n1:已经结算', 178, 0, 1, 1438777898, 1438776104, '', 3, '', 'regex', '', 3, 'function'),
(1533, 'pid', '商品id', 'int(10) NOT NULL', 'num', '', '商品id', 1, '', 178, 0, 1, 1438263721, 1438263721, '', 3, '', 'regex', '', 3, 'function'),
(1532, 'unit_price', '单价', 'int(10) NOT NULL', 'num', '', '单价', 1, '', 178, 0, 1, 1437899991, 1437899991, '', 3, '', 'regex', '', 3, 'function'),
(1531, 'product_field', '商品', 'text NOT NULL', 'textarea', '', '商品信息', 0, '', 178, 0, 1, 1437698461, 1437698461, '', 3, '', 'regex', '', 3, 'function'),
(1530, 'total_fee', '总费用', 'int(10) NOT NULL', 'num', '', '总费用', 1, '', 178, 0, 1, 1437698489, 1437698489, '', 3, '', 'regex', '', 3, 'function'),
(1529, 'ip', '支付ip', 'varchar(255) NOT NULL', 'string', '', '支付ip', 1, '', 178, 0, 1, 1437698530, 1437698530, '', 3, '', 'regex', '', 3, 'function'),
(1525, 'userinfo', '收件人信息', 'text NOT NULL', 'textarea', '', '收件人信息', 0, '', 178, 0, 1, 1445573073, 1437725908, '', 3, '', 'regex', '', 3, 'function'),
(1524, 'fid', '订单的fid', 'int(10) NOT NULL', 'num', '', '订单的父id', 1, '', 178, 0, 1, 1437831058, 1437831058, '', 3, '', 'regex', '', 3, 'function'),
(1523, 'count', '商品数量', 'int(10) NOT NULL', 'num', '', '商品数量', 1, '', 178, 0, 1, 1437831288, 1437831288, '', 3, '', 'regex', '', 3, 'function'),
(1522, 'title', '商品名称', 'varchar(255) NOT NULL', 'string', '', '商品名称', 1, '', 178, 0, 1, 1437895825, 1437895825, '', 3, '', 'regex', '', 3, 'function'),
(1520, 'openid', '任何用户的openid', 'varchar(255) NOT NULL', 'string', '', 'openid', 0, '', 177, 0, 1, 1445064013, 1438673562, '', 3, '', 'regex', '', 3, 'function'),
(1519, 'seller_openid', '二级分销', 'varchar(255) NOT NULL', 'string', '', '二级分销', 0, '', 177, 0, 1, 1445064043, 1438673473, '', 3, '', 'regex', '', 3, 'function'),
(1624, 'token', 'Token', 'varchar(255) NOT NULL', 'string', '', '', 0, '', 188, 0, 1, 1396602871, 1396602859, '', 3, '', 'regex', 'get_token', 1, 'function'),
(1623, 'cTime', '发布时间', 'int(10) unsigned NOT NULL ', 'datetime', '', '', 0, '', 188, 0, 1, 1396624612, 1396075102, '', 3, '', 'regex', 'time', 1, 'function'),
(1621, 'cover', '商品封面图片', 'int(10) unsigned NOT NULL ', 'picture', '', '', 1, '', 188, 0, 1, 1397521134, 1396062093, '', 3, '', 'regex', '', 3, 'function');
INSERT INTO `wp_attribute` (`id`, `name`, `title`, `field`, `type`, `value`, `remark`, `is_show`, `extra`, `model_id`, `is_must`, `status`, `update_time`, `create_time`, `validate_rule`, `validate_time`, `error_info`, `validate_type`, `auto_rule`, `auto_time`, `auto_type`) VALUES
(1618, 'title', '商品名称', 'varchar(255) NOT NULL', 'string', '', '', 1, '', 188, 1, 1, 1397520732, 1396061859, '', 3, '', 'regex', '', 3, 'function'),
(1619, 'intro', '商品简介', 'text NOT NULL', 'textarea', '', '', 1, '', 188, 0, 1, 1397521079, 1396061947, '', 3, '', 'regex', '', 3, 'function'),
(1620, 'mTime', '修改时间', 'int(10) NOT NULL', 'datetime', '', '', 0, '', 188, 0, 1, 1396624664, 1396624664, '', 3, '', 'regex', 'time', 3, 'function'),
(1616, 'img_1', '商品图片1', 'int(10) unsigned NOT NULL ', 'picture', '', '', 1, '', 188, 0, 1, 1398598870, 1398598870, '', 3, '', 'regex', '', 3, 'function'),
(1617, 'img_2', '商品图片2', 'int(10) unsigned NOT NULL ', 'picture', '', '', 1, '', 188, 0, 1, 1398598904, 1398598904, '', 3, '', 'regex', '', 3, 'function'),
(1509, 'comments', '评论内容', 'text NOT NULL', 'textarea', '', '评论', 1, '', 175, 0, 1, 1438247061, 1438247061, '', 3, '', 'regex', '', 3, 'function'),
(1511, 'ctime', '时间', 'int(10) NOT NULL', 'datetime', '', '评论的时间', 1, '', 175, 0, 1, 1438248818, 1438248818, '', 3, '', 'regex', '', 3, 'function'),
(1510, 'token', 'token', 'varchar(255) NOT NULL', 'string', '', '', 1, '', 175, 0, 1, 1438248787, 1438248737, '', 3, '', 'regex', 'get_token', 3, 'function'),
(1508, 'gid', '商品id', 'int(10) NOT NULL', 'num', '', '商品id', 1, '', 175, 0, 1, 1438251563, 1438247021, '', 3, '', 'regex', '', 3, 'function'),
(1581, 'status', '退单状态', 'int(10) NOT NULL', 'select', '2', '退单状态', 1, '1:退款成功\r\n2:待退款\r\n3:退款失败', 182, 0, 1, 1438876302, 1438876287, '', 3, '', 'regex', '', 3, 'function'),
(1582, 'ctime', '创建时间', 'int(10) NOT NULL', 'datetime', '', '', 1, '', 184, 0, 1, 1437701869, 1437701869, '', 3, '', 'regex', '', 3, 'function'),
(1583, 'nickname', '昵称', 'varchar(255) NOT NULL', 'string', '', '昵称', 1, '', 184, 0, 1, 1437701780, 1437701780, '', 3, '', 'regex', '', 3, 'function'),
(1584, 'openid', '微信用户的openid', 'varchar(255) NOT NULL', 'string', '', '微信用户openid', 1, '', 184, 0, 1, 1437701744, 1437701744, '', 3, '', 'regex', '', 3, 'function'),
(1585, 'token', 'token', 'varchar(255) NOT NULL', 'string', '', '', 1, '', 184, 0, 1, 1437701886, 1437701886, '', 3, '', 'regex', '', 3, 'function'),
(1586, 'address', '地址', 'varchar(255) NOT NULL', 'string', '', '地址', 1, '', 184, 0, 1, 1437701843, 1437701843, '', 3, '', 'regex', '', 3, 'function'),
(1587, 'phone', '电话', 'varchar(255) NOT NULL', 'string', '', '电话', 1, '', 184, 0, 1, 1437701814, 1437701814, '', 3, '', 'regex', '', 3, 'function'),
(1588, 'remain_money', '账户余额', 'int(10) NOT NULL', 'num', '', '余额', 1, '', 184, 0, 1, 1438338265, 1438338265, '', 3, '', 'regex', '', 3, 'function'),
(1589, 'user_cat', '用户类型', 'char(10) NOT NULL', 'select', '999', '用户类型', 1, '0:合伙人\r\n1:总代理\r\n2:分销商\r\n999:普通用户', 184, 0, 1, 1438747812, 1438747812, '', 3, '', 'regex', '', 3, 'function'),
(1590, 'credit', '积分', 'int(10) NOT NULL', 'num', '', '积分', 1, '', 184, 0, 1, 1438874125, 1438874125, '', 3, '', 'regex', '', 3, 'function'),
(1591, 'profit_percentage', '合伙人的利润提成百分比（以小数形式表示），非合伙人类别，填了也没用', 'varchar(255) NOT NULL', 'string', '', '合伙人的利润提成百分比（以小数形式表示），非合伙人类别，填了也没用', 1, '', 184, 0, 1, 1438875461, 1438875461, '', 3, '', 'regex', '', 3, 'function'),
(1592, 'return_code', '返回状态码', 'varchar(255) NOT NULL', 'string', '', '返回状态吗', 1, '', 187, 0, 1, 1439003539, 1439003539, '', 3, '', 'regex', '', 3, 'function'),
(1593, 'return_msg', '返回信息', 'varchar(255) NOT NULL', 'string', '', '返回信息', 1, '', 187, 0, 1, 1439003578, 1439003578, '', 3, '', 'regex', '', 3, 'function'),
(1594, 'appid', 'apppid', 'varchar(255) NOT NULL', 'string', '', 'appid', 1, '', 187, 0, 1, 1439003628, 1439003628, '', 3, '', 'regex', '', 3, 'function'),
(1595, 'mch_id', '商户号', 'varchar(255) NOT NULL', 'string', '', '商户号', 1, '', 187, 0, 1, 1439003659, 1439003659, '', 3, '', 'regex', '', 3, 'function'),
(1596, 'nonce_str', '随机字符串', 'varchar(255) NOT NULL', 'string', '', '随机字符串', 1, '', 187, 0, 1, 1439003682, 1439003682, '', 3, '', 'regex', '', 3, 'function'),
(1597, 'sign', '签名', 'varchar(255) NOT NULL', 'string', '', '签名', 1, '', 187, 0, 1, 1439003736, 1439003736, '', 3, '', 'regex', '', 3, 'function'),
(1598, 'is_subscribe', '是否关注公众号', 'varchar(255) NOT NULL', 'string', '', '是否关注公众号', 1, '', 187, 0, 1, 1439003812, 1439003812, '', 3, '', 'regex', '', 3, 'function'),
(1599, 'trade_type', '交易类型', 'varchar(255) NOT NULL', 'string', '', '交易类型', 1, '', 187, 0, 1, 1439003865, 1439003865, '', 3, '', 'regex', '', 3, 'function'),
(1600, 'trade_state', '交易状态', 'varchar(255) NOT NULL', 'string', '', '交易状态', 1, '', 187, 0, 1, 1439003896, 1439003896, '', 3, '', 'regex', '', 3, 'function'),
(1601, 'bank_type', '付款银行', 'varchar(255) NOT NULL', 'string', '', '付款银行', 1, '', 187, 0, 1, 1439003926, 1439003926, '', 3, '', 'regex', '', 3, 'function'),
(1602, 'total_fee', '总金额', 'int(10) NOT NULL', 'num', '', '总金额', 1, '', 187, 0, 1, 1439003946, 1439003946, '', 3, '', 'regex', '', 3, 'function'),
(1603, 'cash_fee', '现金支付金额', 'int(10) NOT NULL', 'num', '', '现金支付金额', 1, '', 187, 0, 1, 1439003988, 1439003988, '', 3, '', 'regex', '', 3, 'function'),
(1604, 'fee_type', '现金支付货币类型', 'varchar(255) NOT NULL', 'string', '', '现金支付货币类型', 1, '', 187, 0, 1, 1439077917, 1439004025, '', 3, '', 'regex', '', 3, 'function'),
(1605, 'coupon_fee', '代金券或立减优惠金额', 'int(10) NOT NULL', 'num', '', '代金券或立减优惠金额', 1, '', 187, 0, 1, 1439004065, 1439004065, '', 3, '', 'regex', '', 3, 'function'),
(1606, 'coupon_count', '代金券或立减优惠使用数量', 'int(10) NOT NULL', 'num', '', '代金券或立减优惠使用数量', 1, '', 187, 0, 1, 1439004095, 1439004095, '', 3, '', 'regex', '', 3, 'function'),
(1607, 'transaction_id', '微信支付订单号', 'varchar(255) NOT NULL', 'string', '', '微信支付订单号', 1, '', 187, 0, 1, 1439004170, 1439004170, '', 3, '', 'regex', '', 3, 'function'),
(1608, 'out_trade_no', '商户订单号', 'varchar(255) NOT NULL', 'string', '', '商户订单号', 1, '', 187, 0, 1, 1439004203, 1439004203, '', 3, '', 'regex', '', 3, 'function'),
(1609, 'time_end', '支付完成时间', 'varchar(255) NOT NULL', 'string', '', '支付完成时间', 1, '', 187, 0, 1, 1439004225, 1439004225, '', 3, '', 'regex', '', 3, 'function'),
(1610, 'trade_state_desc', '交易状态描述', 'varchar(255) NOT NULL', 'string', '', '交易状态描述', 1, '', 187, 0, 1, 1439004259, 1439004259, '', 3, '', 'regex', '', 3, 'function'),
(1611, 'out_trade_no', '商户支付订单号', 'varchar(255) NOT NULL', 'string', '', '商户支付订单号', 1, '', 178, 0, 1, 1439038930, 1439038930, '', 3, '', 'regex', '', 3, 'function'),
(1612, 'token', 'token', 'varchar(255) NOT NULL', 'string', '', 'token', 1, '', 178, 0, 1, 1439045607, 1439045607, '', 3, '', 'regex', '', 3, 'function'),
(1613, 'result_code', '业务结果', 'varchar(255) NOT NULL', 'string', '', '业务结果', 1, '', 187, 0, 1, 1439077226, 1439077226, '', 3, '', 'regex', '', 3, 'function'),
(1614, 'openid', 'openid', 'varchar(255) NOT NULL', 'string', '', 'openid', 1, '', 187, 0, 1, 1439077324, 1439077324, '', 3, '', 'regex', '', 3, 'function'),
(1615, 'attach', '', 'text NOT NULL', 'textarea', '', '', 1, '', 187, 0, 1, 1439078046, 1439078046, '', 3, '', 'regex', '', 3, 'function'),
(1651, 'last_state', '物流最新状态', 'int(1) NOT NULL', 'select', '0', '', 3, '0:在途，即货物处于运输过程中；\r\n1:揽件，货物已由快递公司揽收并且产生了第一条跟踪信息；\r\n2:疑难，货物寄送过程出了问题；\r\n3:签收，收件人已签收；\r\n4:退签，即货物由于用户拒签、超区等原因退回，而且发件人已经签收；\r\n5:派件，即快递正在进行同城派件；\r\n6:退回，货物正处于退回发件人的途中；', 190, 0, 1, 1439276270, 1439191386, '', 3, '', 'regex', '', 3, 'function'),
(1652, 'order_id', '单号ID', 'int(32) NOT NULL', 'cascade', '', '', 2, '', 190, 1, 1, 1444126889, 1439191569, '', 3, '', 'regex', '', 3, 'function'),
(1653, 'postid', '快递单号', 'varchar(255) NOT NULL', 'string', '', '', 1, '', 190, 1, 1, 1439277490, 1439192154, '', 3, '', 'regex', '', 3, 'function'),
(1654, 'express_fee', '快递费', 'int(10) NOT NULL', 'num', '', '', 1, '', 188, 0, 1, 1440665810, 1440665810, '', 3, '', 'regex', '', 3, 'function'),
(1655, 'stock_count', '库存', 'int(10) NOT NULL', 'num', '', '', 1, '', 188, 0, 1, 1440665834, 1440665834, '', 3, '', 'regex', '', 3, 'function'),
(1656, 'is_limit', '限购', 'char(50) NOT NULL', 'select', '0', '', 1, '0:不限购\r\n1:限购', 188, 0, 1, 1440665881, 1440665881, '', 3, '', 'regex', '', 3, 'function'),
(1657, 'limit_count', '限购数量', 'int(10) NOT NULL', 'num', '1', '', 1, '', 188, 0, 1, 1440665919, 1440665919, '', 3, '', 'regex', '', 3, 'function'),
(1658, 'express_fee', '快递费', 'int(10) NOT NULL', 'num', '', '', 1, '', 178, 0, 1, 1440666141, 1440666141, '', 3, '', 'regex', '', 3, 'function'),
(1659, 'express_fee_in_province', '省内快递费', 'int(10) NOT NULL', 'num', '', '省内快递费', 1, '', 188, 0, 1, 1440993477, 1440993477, '', 3, '', 'regex', '', 3, 'function'),
(1660, 'express_fee_out_province', '省外快递费', 'int(10) NOT NULL', 'num', '', '', 1, '', 188, 0, 1, 1440993507, 1440993507, '', 3, '', 'regex', '', 3, 'function'),
(1661, 'shangjia', '上架', 'char(10) NOT NULL', 'radio', '下架', '', 1, '上架:是\r\n下架:否', 188, 1, 1, 1441067371, 1441067371, '', 3, '', 'regex', '', 3, 'function'),
(1662, 'user_id', '用户ID', 'int(10) UNSIGNED NOT NULL', 'num', '', '', 0, '', 191, 0, 1, 1440470719, 1440223141, '', 3, '', 'regex', '', 3, 'function'),
(1663, 'wechat', '微信', 'varchar(255) NOT NULL', 'string', '', '', 1, '', 191, 0, 1, 1440404784, 1440404729, '', 3, '', 'regex', '', 3, 'function'),
(1664, 'description', '转发描述', 'varchar(255)', 'string', '', '', 1, '', 191, 1, 1, 1440468744, 1439888141, '', 3, '', 'regex', '', 3, 'function'),
(1665, 'info', '其他', 'text NOT NULL', 'textarea', '', '', 0, '', 191, 0, 1, 1441070833, 1439878250, '', 3, '', 'regex', '', 3, 'function'),
(1666, 'token', 'token', 'varchar(255) NOT NULL', 'string', '', '', 0, '', 191, 0, 1, 1439877543, 1439877543, '', 3, '', 'regex', '', 3, 'function'),
(1667, 'qr_code', '二维码', 'varchar(255) NOT NULL', 'string', '', '', 0, '', 191, 0, 1, 1439877727, 1439877727, '', 3, '', 'regex', '', 3, 'function'),
(1668, 'ownername', '姓名', 'varchar(255) NOT NULL', 'string', '', '', 1, '', 191, 1, 1, 1439877498, 1439877498, '', 3, '', 'regex', '', 3, 'function'),
(1669, 'company_name', '公司', 'varchar(255) NOT NULL', 'string', '', '', 1, '', 191, 0, 1, 1439877931, 1439877931, '', 3, '', 'regex', '', 3, 'function'),
(1670, 'portrait', '头像', 'int(10) UNSIGNED NOT NULL', 'picture', '', '', 1, '', 191, 1, 1, 1439877753, 1439877753, '', 3, '', 'regex', '', 3, 'function'),
(1671, 'phone', '手机', 'varchar(255) NOT NULL', 'string', '', '', 1, '', 191, 0, 1, 1439877811, 1439877811, '', 3, '', 'regex', '', 3, 'function'),
(1672, 'tel', '电话', 'varchar(255) NOT NULL', 'string', '', '', 1, '', 191, 0, 1, 1439877797, 1439877797, '', 3, '', 'regex', '', 3, 'function'),
(1673, 'post', '职位', 'varchar(255) NOT NULL', 'string', '', '', 1, '', 191, 0, 1, 1439877777, 1439877777, '', 3, '', 'regex', '', 3, 'function'),
(1674, 'fax', '传真', 'varchar(255) NOT NULL', 'string', '', '', 0, '', 191, 0, 1, 1441070811, 1439877825, '', 3, '', 'regex', '', 3, 'function'),
(1675, 'email', '邮箱', 'varchar(255) NOT NULL', 'string', '', '', 1, '', 191, 0, 1, 1439877853, 1439877853, '', 3, '', 'regex', '', 3, 'function'),
(1676, 'QQ', 'QQ', 'varchar(255) NOT NULL', 'string', '', '', 1, '', 191, 0, 1, 1439877838, 1439877838, '', 3, '', 'regex', '', 3, 'function'),
(1677, 'company_addr', '公司地址', 'varchar(255) NOT NULL', 'string', '', '', 1, '', 191, 0, 1, 1439877872, 1439877872, '', 3, '', 'regex', '', 3, 'function'),
(1678, 'company_url', '公司网址', 'varchar(255) NOT NULL', 'string', '', '', 1, '', 191, 0, 1, 1439877885, 1439877885, '', 3, '', 'regex', '', 3, 'function'),
(1679, 'share_count', '分享统计', 'int(10) NOT NULL', 'num', '0', '', 0, '', 191, 0, 1, 1440232526, 1440232526, '', 3, '', 'regex', '', 3, 'function'),
(1680, 'url', '外链地址', 'varchar(255) NOT NULL', 'string', '', '', 1, '', 192, 1, 1, 1440379330, 1440379330, '', 3, '', 'regex', '', 3, 'function'),
(1681, 'title', '外链标题', 'varchar(255) NOT NULL', 'string', '', '', 1, '', 192, 1, 1, 1440379354, 1440379354, '', 3, '', 'regex', '', 3, 'function'),
(1682, 'hccard_id', '名片ID', 'int(10) NOT NULL', 'num', '', '', 0, '', 192, 1, 1, 1441856041, 1440379401, '', 3, '', 'regex', '', 3, 'function'),
(1683, 'title', '标题', 'varchar(255) NOT NULL', 'string', '', '', 1, '', 193, 1, 1, 1440491666, 1440379056, '', 3, '', 'regex', '', 3, 'function'),
(1684, 'desc', '描述', 'varchar(255) NOT NULL', 'string', '', '', 1, '', 193, 0, 1, 1440379075, 1440379075, '', 3, '', 'regex', '', 3, 'function'),
(1685, 'pic', '图片', 'int(10) UNSIGNED NOT NULL', 'picture', '', '', 1, '', 193, 0, 1, 1440379100, 1440379100, '', 3, '', 'regex', '', 3, 'function'),
(1686, 'content', '内容', 'text NOT NULL', 'editor', '', '', 1, '', 193, 1, 1, 1440379149, 1440379149, '', 3, '', 'regex', '', 3, 'function'),
(1687, 'hccard_id', '名片ID', 'int(10) NOT NULL', 'num', '', '', 0, '', 193, 1, 1, 1440484668, 1440379249, '', 3, '', 'regex', '', 3, 'function'),
(1688, 'name', '姓名', 'varchar(255) NOT NULL', 'string', '', '', 1, '', 194, 0, 1, 1440223842, 1440223842, '', 3, '', 'regex', '', 3, 'function'),
(1689, 'hccard_id', '微名片ID', 'int(10) NOT NULL', 'num', '', '', 0, '', 194, 1, 1, 1440223851, 1440223787, '', 3, '', 'regex', '', 3, 'function'),
(1690, 'tel', '联系电话', 'varchar(255) NOT NULL', 'string', '', '', 1, '', 194, 0, 1, 1440223963, 1440223963, '', 3, '', 'regex', '', 3, 'function'),
(1691, 'content', '内容', 'text NOT NULL', 'textarea', '', '', 1, '', 194, 1, 1, 1440224014, 1440224014, '', 3, '', 'regex', '', 3, 'function'),
(1692, 'state', '状态', 'char(50) NOT NULL', 'select', '未查看', '', 0, '未查看:未查看\r\n已查看:已查看\r\n\r\n', 194, 0, 1, 1440224229, 1440224229, '', 3, '', 'regex', '', 3, 'function'),
(1832, 'sort', '排序号', 'int(10) unsigned NOT NULL ', 'num', '0', '值越小越靠前', 1, '', 212, 0, 1, 1396685825, 1396685825, '', 3, '', 'regex', '', 3, 'function'),
(1825, 'extra', '参数', 'text NOT NULL', 'textarea', '', '字段类型为单选、多选、下拉选择和级联选择时的定义数据，其它字段类型为空', 1, '', 212, 0, 1, 1396835020, 1396685105, '', 3, '', 'regex', '', 3, 'function'),
(1826, 'value', '默认值', 'varchar(255) NOT NULL', 'string', '', '字段的默认值', 1, '', 212, 0, 1, 1396685291, 1396685291, '', 3, '', 'regex', '', 3, 'function'),
(1827, 'token', 'Token', 'varchar(255) NOT NULL', 'string', '', '', 0, '', 212, 0, 1, 1396602871, 1396602859, '', 3, '', 'regex', 'get_token', 1, 'function'),
(1828, 'name', '字段名', 'varchar(100) NOT NULL', 'string', '', '请输入字段名 英文字母开头，长度不超过30', 1, '', 212, 1, 1, 1396676840, 1396676792, '', 3, '', 'regex', '', 3, 'function'),
(1824, 'mTime', '修改时间', 'int(10) NOT NULL', 'datetime', '', '', 0, '', 212, 0, 1, 1396624664, 1396624664, '', 3, '', 'regex', 'time', 3, 'function'),
(1822, 'type', '字段类型', 'char(50) NOT NULL', 'select', 'string', '用于表单中的展示方式', 1, 'string:单行输入\r\ntextarea:多行输入\r\nradio:单选\r\ncheckbox:多选\r\nselect:下拉选择\r\ndatetime:时间\r\npicture:上传图片\r\ncascade:级联', 212, 1, 1, 1398742035, 1396683600, '', 3, '', 'regex', '', 3, 'function'),
(1821, 'jump_url', '提交后跳转的地址', 'varchar(255) NOT NULL', 'string', '', '要以http://开头的完整地址，为空时不跳转', 1, '', 211, 0, 1, 1399800276, 1399800276, '', 3, '', 'regex', '', 3, 'function'),
(1784, 'keyword', '关键词', 'varchar(50) NOT NULL', 'string', '', '用户在微信里回复此关键词将会触发此投票。', 1, '', 206, 1, 1, 1392969972, 1388930888, 'keyword_unique', 1, '此关键词已经存在，请换成别的关键词再试试', 'function', '', 3, 'function'),
(1823, 'title', '字段标题', 'varchar(255) NOT NULL', 'string', '', '请输入字段标题，用于表单显示', 1, '', 212, 1, 1, 1396676830, 1396676830, '', 3, '', 'regex', '', 3, 'function'),
(1796, 'name', '选项标题', 'varchar(255) NOT NULL', 'string', '', '', 1, '', 207, 1, 1, 1388933552, 1388933552, '', 3, '', 'regex', '', 3, 'function'),
(1803, 'options', '选择选项', 'varchar(255) NOT NULL', 'string', '', '', 0, '', 208, 1, 1, 1388934351, 1388934351, '', 3, '', 'regex', '', 3, 'function'),
(1804, 'cTime', '创建时间', 'int(10) NOT NULL', 'datetime', '', '', 0, '', 208, 0, 1, 1388934413, 1388934392, '', 3, '', 'regex', 'time', 3, 'function'),
(1805, 'vote_id', '投票ID', 'int(10) NOT NULL', 'num', '', '', 1, '', 209, 1, 1, 1441098288, 1441098288, '', 3, '', 'regex', '', 3, 'function'),
(1806, 'forms_id', '表单ID', 'int(10) NOT NULL', 'num', '', '', 1, '', 209, 1, 1, 1441098266, 1441098266, '', 3, '', 'regex', '', 3, 'function'),
(1807, 'value_id', '报名ID', 'int(10) NOT NULL', 'num', '', '', 1, '', 210, 1, 1, 1441095978, 1441095978, '', 3, '', 'regex', '', 3, 'function'),
(1808, 'opt_id', '选项ID', 'int(10) NOT NULL', 'num', '', '', 1, '', 210, 1, 1, 1441095886, 1441095886, '', 3, '', 'regex', '', 3, 'function'),
(1809, 'finish_tip', '用户提交后提示内容', 'text NOT NULL', 'textarea', '', '为空默认为：提交成功，谢谢参与', 1, '', 211, 0, 1, 1396676366, 1396673689, '', 3, '', 'regex', '', 3, 'function'),
(1810, 'cTime', '发布时间', 'int(10) unsigned NOT NULL ', 'datetime', '', '', 0, '', 211, 0, 1, 1396624612, 1396075102, '', 3, '', 'regex', 'time', 1, 'function'),
(1811, 'token', 'Token', 'varchar(255) NOT NULL', 'string', '', '', 0, '', 211, 0, 1, 1396602871, 1396602859, '', 3, '', 'regex', 'get_token', 1, 'function'),
(1812, 'password', '表单密码', 'varchar(255) NOT NULL', 'string', '', '如要用户输入密码才能进入表单，则填写此项。否则留空，用户可直接进入表单', 0, '', 211, 0, 1, 1396871497, 1396672643, '', 3, '', 'regex', '', 3, 'function'),
(1813, 'keyword_type', '关键词类型', 'tinyint(2) NOT NULL', 'select', '0', '', 1, '0:完全匹配\r\n1:左边匹配\r\n2:右边匹配\r\n3:模糊匹配', 211, 1, 1, 1396624426, 1396061765, '', 3, '', 'regex', '', 3, 'function'),
(1814, 'title', '标题', 'varchar(255) NOT NULL', 'string', '', '', 1, '', 211, 1, 1, 1396624461, 1396061859, '', 3, '', 'regex', '', 3, 'function'),
(1815, 'intro', '封面简介', 'text NOT NULL', 'textarea', '', '', 1, '', 211, 0, 1, 1396624505, 1396061947, '', 3, '', 'regex', '', 3, 'function'),
(1816, 'mTime', '修改时间', 'int(10) NOT NULL', 'datetime', '', '', 0, '', 211, 0, 1, 1396624664, 1396624664, '', 3, '', 'regex', 'time', 3, 'function'),
(1817, 'cover', '封面图片', 'int(10) unsigned NOT NULL ', 'picture', '', '', 1, '', 211, 0, 1, 1396624534, 1396062093, '', 3, '', 'regex', '', 3, 'function'),
(1818, 'keyword', '关键词', 'varchar(100) NOT NULL', 'string', '', '', 1, '', 211, 1, 1, 1396866048, 1396061575, '', 3, '', 'regex', '', 3, 'function'),
(1819, 'can_edit', '是否允许编辑', 'tinyint(2) NOT NULL', 'bool', '0', '用户提交表单是否可以再编辑', 1, '0:不允许\r\n1:允许', 211, 0, 1, 1396688624, 1396688624, '', 3, '', 'regex', '', 3, 'function'),
(1820, 'content', '详细介绍', 'text NOT NULL', 'editor', '', '可不填', 1, '', 211, 0, 1, 1396865295, 1396865295, '', 3, '', 'regex', '', 3, 'function'),
(1785, 'title', '投票标题', 'varchar(100) NOT NULL', 'string', '', '', 1, '', 206, 1, 1, 1388931041, 1388931041, '', 3, '', 'regex', '', 3, 'function'),
(1786, 'description', '投票描述', 'text NOT NULL', 'textarea', '', '', 1, '', 206, 0, 1, 1400633517, 1388931173, '', 3, '', 'regex', '', 3, 'function'),
(1787, 'picurl', '封面图片', 'int(10) unsigned NOT NULL ', 'picture', '', '支持JPG、PNG格式，较好的效果为大图360*200，小图200*200', 1, '', 206, 0, 1, 1388931285, 1388931285, '', 3, '', 'regex', '', 3, 'function'),
(1788, 'type', '选择类型', 'char(10) NOT NULL', 'radio', '0', '', 1, '0:单选\r\n1:多选', 206, 1, 1, 1388936429, 1388931487, '', 3, '', 'regex', '', 3, 'function'),
(1789, 'start_date', '开始日期', 'int(10) NOT NULL', 'datetime', '', '', 1, '', 206, 0, 1, 1388931734, 1388931734, '', 3, '', 'regex', '', 3, 'function'),
(1790, 'end_date', '结束日期', 'int(10) NOT NULL', 'datetime', '', '', 1, '', 206, 0, 1, 1388931769, 1388931769, '', 3, '', 'regex', '', 3, 'function'),
(1791, 'is_img', '文字/图片投票', 'tinyint(2) NOT NULL', 'radio', '0', '', 0, '0:文字投票\r\n1:图片投票', 206, 1, 1, 1389081985, 1388931941, '', 3, '', 'regex', '', 3, 'function'),
(1792, 'vote_count', '投票数', 'int(10) unsigned NOT NULL ', 'num', '0', '', 0, '', 206, 0, 1, 1388932035, 1388932035, '', 3, '', 'regex', '', 3, 'function'),
(1793, 'cTime', '投票创建时间', 'int(10) NOT NULL', 'datetime', '', '', 0, '', 206, 1, 1, 1388932128, 1388932128, '', 1, '', 'regex', 'time', 3, 'function'),
(1794, 'mTime', '更新时间', 'int(10) NOT NULL', 'datetime', '', '', 0, '', 206, 0, 1, 1390634006, 1390634006, '', 3, '', 'regex', '', 3, 'function'),
(1795, 'token', 'Token', 'varchar(255) NOT NULL', 'string', '', '', 0, '', 206, 0, 1, 1391397388, 1391397388, '', 3, '', 'regex', '', 3, 'function'),
(1797, 'image', '图片选项', 'int(10) unsigned NOT NULL ', 'picture', '', '', 5, '', 207, 0, 1, 1388984467, 1388933679, '', 3, '', 'regex', '', 3, 'function'),
(1798, 'opt_count', '当前选项投票数', 'int(10) unsigned NOT NULL ', 'num', '0', '', 0, '', 207, 0, 1, 1388933860, 1388933860, '', 3, '', 'regex', '', 3, 'function'),
(1799, 'order', '选项排序', 'int(10) unsigned NOT NULL ', 'num', '0', '', 1, '', 207, 0, 1, 1388933951, 1388933951, '', 3, '', 'regex', '', 3, 'function'),
(1800, 'vote_id', '投票ID', 'int(10) unsigned NOT NULL ', 'num', '', '', 0, '', 208, 1, 1, 1388934189, 1388934189, '', 3, '', 'regex', '', 3, 'function'),
(1801, 'user_id', '用户ID', 'int(10) NOT NULL ', 'num', '', '', 0, '', 208, 0, 1, 1388934265, 1388934265, '', 3, '', 'regex', '', 3, 'function'),
(1802, 'token', '用户TOKEN', 'varchar(255) NOT NULL', 'string', '', '', 0, '', 208, 0, 1, 1388934296, 1388934296, '', 3, '', 'regex', '', 3, 'function'),
(1843, 'ctime', '创建时间', 'int(10) NOT NULL', 'datetime', '', '', 1, '', 214, 0, 1, 1442397222, 1442397222, '', 3, '', 'regex', '', 3, 'function'),
(1837, 'openid', 'OpenId', 'varchar(255) NOT NULL', 'string', '', '', 0, '', 213, 0, 1, 1396688187, 1396688187, '', 3, '', 'regex', 'get_openid', 1, 'function'),
(1834, 'forms_cjt_id', '表单ID', 'int(10) unsigned NOT NULL ', 'num', '', '', 4, '', 212, 0, 1, 1396710040, 1396690613, '', 3, '', 'regex', '', 3, 'function'),
(1835, 'is_show', '是否显示', 'tinyint(2) NOT NULL', 'select', '1', '是否显示在表单中', 1, '1:显示\r\n0:不显示', 212, 0, 1, 1396848437, 1396848437, '', 3, '', 'regex', '', 3, 'function'),
(1833, 'error_info', '出错提示', 'varchar(255) NOT NULL', 'string', '', '验证不通过时的提示语', 1, '', 212, 0, 1, 1396685920, 1396685920, '', 3, '', 'regex', '', 3, 'function'),
(1842, 'token', 'token', 'varchar(255) NOT NULL', 'string', '', '', 1, '', 214, 0, 1, 1442397191, 1442397191, '', 3, '', 'regex', '', 3, 'function'),
(1840, 'cTime', '增加时间', 'int(10) NOT NULL', 'datetime', '', '', 0, '', 213, 0, 1, 1396688434, 1396688434, '', 3, '', 'regex', 'time', 1, 'function'),
(1841, 'token', 'Token', 'varchar(255) NOT NULL', 'string', '', '', 0, '', 213, 0, 1, 1396690911, 1396690911, '', 3, '', 'regex', 'get_token', 1, 'function'),
(1838, 'forms_cjt_id', '表单ID', 'int(10) unsigned NOT NULL ', 'num', '', '', 4, '', 213, 0, 1, 1396710064, 1396688308, '', 3, '', 'regex', '', 1, 'function'),
(1839, 'value', '表单值', 'text NOT NULL', 'textarea', '', '', 0, '', 213, 0, 1, 1396688355, 1396688355, '', 3, '', 'regex', '', 3, 'function'),
(1844, 'pid', '商品ID', 'int(10) NOT NULL', 'num', '', '', 1, '', 214, 0, 1, 1442397295, 1442397243, '', 3, '', 'regex', '', 3, 'function'),
(1836, 'uid', '用户ID', 'int(10) NULL ', 'num', '', '', 0, '', 213, 0, 1, 1396688042, 1396688042, '', 3, '', 'regex', '', 3, 'function'),
(1831, 'validate_rule', '正则验证', 'varchar(255) NOT NULL', 'string', '', '为空表示不作验证', 1, '', 212, 0, 1, 1396685776, 1396685776, '', 3, '', 'regex', '', 3, 'function'),
(1830, 'is_must', '是否必填', 'tinyint(2) NOT NULL', 'bool', '', '用于自动验证', 1, '0:否\r\n1:是', 212, 0, 1, 1396685579, 1396685579, '', 3, '', 'regex', '', 3, 'function'),
(1829, 'remark', '字段备注', 'varchar(255) NOT NULL', 'string', '', '用于表单中的提示', 1, '', 212, 0, 1, 1396685482, 1396685482, '', 3, '', 'regex', '', 3, 'function'),
(1861, 'states', '活动状态', 'char(10) NOT NULL ', 'radio', '0', '', 0, '0:未开始\r\n1:已结束', 216, 0, 1, 1395395602, 1395395179, '', 0, '', 'regex', '', 0, 'function'),
(1858, 'exchange', '积分兑换', 'int(10) NOT NULL', 'num', '0', '可以兑换积分的最大值', 1, '', 188, 0, 1, 1445496796, 1445496796, '', 3, '', 'regex', '', 3, 'function'),
(1857, 'score', '财富值', 'int(10) NOT NULL', 'num', '0', '', 1, '', 188, 0, 1, 1445389979, 1445389979, '', 3, '', 'regex', '', 3, 'function'),
(1860, 'cTime', '活动创建时间', 'int(10) NOT NULL ', 'datetime', '', '', 0, '', 216, 0, 1, 1395395963, 1395395179, '', 3, '', 'regex', 'time', 3, 'function'),
(1859, 'end_date', '结束日期', 'int(10) NOT NULL ', 'datetime', '', '', 1, '', 216, 0, 1, 1395395670, 1395395179, '', 0, '', 'regex', '', 0, 'function'),
(1856, 'experience', '经验值', 'int(10) NOT NULL', 'num', '0', '', 1, '', 188, 0, 1, 1445389943, 1445389943, '', 3, '', 'regex', '', 3, 'function'),
(1855, 'note', '备注', 'text NOT NULL', 'textarea', '', '', 1, '', 178, 0, 1, 1444959996, 1444959996, '', 3, '', 'regex', '', 3, 'function'),
(1854, 'used', '已使用', 'tinyint(2) NOT NULL', 'bool', '0', '', 1, '', 214, 0, 1, 1444177241, 1444177241, '', 3, '', 'regex', '', 3, 'function'),
(1862, 'picurl', '封面图片', 'int(10) unsigned NOT NULL ', 'picture', '', '', 1, '', 216, 0, 1, 1395395545, 1395395179, '', 0, '', 'regex', '', 0, 'function'),
(1863, 'title', '活动标题', 'varchar(255) NOT NULL ', 'string', '', '', 1, '', 216, 0, 1, 1395395535, 1395395179, '', 0, '', 'regex', '', 0, 'function'),
(1864, 'guiz', '活动规则', 'text NOT NULL ', 'textarea', '', '', 1, '', 216, 0, 1, 1447494398, 1395395179, '', 0, '', 'regex', '', 0, 'function'),
(1865, 'choujnum', '每日抽奖次数', 'int(10) unsigned NOT NULL ', 'num', '0', '', 1, '', 216, 0, 1, 1395395485, 1395395179, '', 0, '', 'regex', '', 0, 'function'),
(1866, 'des', '活动介绍', 'text NOT NULL ', 'editor', '', '', 1, '', 216, 0, 1, 1395395338, 1395395179, '', 0, '', 'regex', '', 0, 'function'),
(1867, 'des_jj', '活动介绍简介', 'text NOT NULL ', 'textarea', '', '活动介绍简介 用于给用户发送消息时候的图文描述', 1, '', 216, 0, 1, 1395395316, 1395395179, '', 0, '', 'regex', '', 0, 'function'),
(1868, 'token', 'Token', 'varchar(255) NOT NULL', 'string', '', '', 0, '', 216, 0, 1, 1395396571, 1395396571, '', 3, '', 'regex', '', 3, 'function'),
(1869, 'keyword', '关键词', 'varchar(255) NOT NULL ', 'string', '', '用户发送 “关键词” 触发', 1, '', 216, 0, 1, 1395395713, 1395395179, '', 0, '', 'regex', '', 0, 'function'),
(1870, 'start_date', '开始时间', 'int(10) NOT NULL ', 'datetime', '', '', 1, '', 216, 0, 1, 1395395676, 1395395179, '', 0, '', 'regex', '', 0, 'function'),
(1871, 'jptype', '奖品类型', 'char(10) NOT NULL ', 'select', '0', '奖品的类型', 1, '0:虚拟\r\n1:实物\r\n2:(无效)优惠券类（需要填写兑奖码且奖品数量为兑奖码数）', 217, 0, 1, 1400992296, 1395395190, '', 3, '', 'regex', '', 3, 'function'),
(1872, 'duijma', '兑奖码', 'text NOT NULL', 'textarea', '', '请输入兑奖码，一行一个', 1, '', 217, 0, 1, 1396253842, 1396253842, '', 3, '', 'regex', '', 3, 'function'),
(1873, 'title', '奖品名称', 'varchar(255) NOT NULL ', 'string', '', '', 1, '', 217, 0, 1, 1395495283, 1395395190, '', 0, '', 'regex', '', 0, 'function'),
(1874, 'pic', '奖品图片', 'int(10) unsigned NOT NULL ', 'picture', '', '', 1, '', 217, 0, 1, 1395495279, 1395395190, '', 0, '', 'regex', '', 0, 'function'),
(1875, 'miaoshu', '奖品描述', 'text NOT NULL ', 'editor', '', '', 1, '', 217, 0, 1, 1395498375, 1395395190, '', 0, '', 'regex', '', 0, 'function'),
(1876, 'num', '库存数量', 'int(10) unsigned NOT NULL ', 'num', '0', '', 1, '', 217, 0, 1, 1396667941, 1395395190, '', 0, '', 'regex', '', 0, 'function'),
(1877, 'isdf', '是否为谢谢惠顾类', 'tinyint(2) NOT NULL', 'bool', '0', '', 1, '0:中奖品\r\n1:该奖为谢谢惠顾类', 217, 0, 1, 1396338661, 1396191564, '', 3, '', 'regex', '', 3, 'function'),
(1878, 'token', 'Token', 'varchar(255) NOT NULL', 'string', '', '', 0, '', 217, 0, 1, 1395554191, 1395554191, '', 3, '', 'regex', '', 3, 'function'),
(1879, 'uid', '用户openid', 'varchar(255) NOT NULL', 'string', '', '', 0, '', 218, 0, 1, 1396686415, 1396686415, '', 3, '', 'regex', '', 3, 'function'),
(1880, 'message', '留言', 'text NOT NULL ', 'string', '', '', 1, '', 218, 0, 1, 1395395200, 1395395200, '', 0, '', '', '', 0, ''),
(1881, 'address', '收件地址', 'text NOT NULL ', 'string', '', '', 1, '', 218, 0, 1, 1395395200, 1395395200, '', 0, '', '', '', 0, ''),
(1882, 'iphone', '电话', 'varchar(255) NOT NULL ', 'string', '', '', 1, '', 218, 0, 1, 1395395200, 1395395200, '', 0, '', '', '', 0, ''),
(1883, 'zip', '邮编', 'int(10) unsigned NOT NULL ', 'string', '', '', 1, '', 218, 0, 1, 1395395200, 1395395200, '', 0, '', '', '', 0, ''),
(1884, 'state', '领奖状态', 'tinyint(2) NOT NULL', 'bool', '0', '', 1, '0:未领取\r\n1:已领取', 218, 0, 1, 1446272333, 1395395200, '', 0, '', 'regex', '', 0, 'function'),
(1885, 'xydzp_option_id', '奖品id', 'int(10) unsigned NOT NULL ', 'string', '0', '', 1, '', 218, 0, 1, 1395395200, 1395395200, '', 0, '', '', '', 0, ''),
(1886, 'xydzp_id', '活动id', 'int(10) unsigned NOT NULL ', 'string', '0', '', 1, '', 218, 0, 1, 1395395200, 1395395200, '', 0, '', '', '', 0, ''),
(1887, 'zjdate', '中奖时间', 'int(10) UNSIGNED NOT NULL', 'num', '', '', 0, '', 218, 0, 1, 1396191999, 1396191999, '', 3, '', 'regex', 'time()', 3, 'function'),
(1888, 'gailv', '中奖概率', 'int(10) UNSIGNED NOT NULL', 'num', '0', '请输入0-100之间书正整数', 1, '', 219, 0, 1, 1395559151, 1395559151, '', 3, '', 'regex', '', 3, 'function'),
(1889, 'gailv_str', '参数', 'varchar(255) NOT NULL', 'string', '', '请输入对应中奖方式的相应值 多个以英文状态下的 逗号(,)分隔', 1, '', 219, 0, 1, 1395559219, 1395559219, '', 3, '', 'regex', '', 3, 'function'),
(1890, 'xydzp_id', '幸运大转盘关联的活动id', 'int(10) UNSIGNED NOT NULL', 'num', '0', '幸运大转盘关联的活动id', 0, '', 219, 0, 1, 1395555019, 1395555019, '', 3, '', 'regex', '', 3, 'function'),
(1891, 'jlnum', '奖励数量', 'int(10) UNSIGNED NOT NULL', 'num', '0', '中奖后，获得该奖品的数量', 1, '', 219, 1, 1, 1395559386, 1395559386, '', 3, '', 'regex', '', 3, 'function'),
(1892, 'type', '奖品中奖方式', 'char(50) NOT NULL', 'select', '0', '选择奖品中奖的方式', 1, '0:按概率中奖\r\n1:按时间中奖(未启用)\r\n2:按顺序中奖(未启用)\r\n3:按指定用户id中奖(未启用)', 219, 0, 1, 1396253189, 1395559102, '', 3, '', 'regex', '', 3, 'function'),
(1893, 'gailv_maxnum', '单日发放上限', 'int(10) UNSIGNED NOT NULL', 'num', '0', '每天最多发放奖品的数量', 1, '', 219, 0, 1, 1395559281, 1395559281, '', 3, '', 'regex', '', 3, 'function'),
(1894, 'xydzp_option_id', '幸运大转盘关联的全局奖品id', 'int(10) UNSIGNED NOT NULL', 'num', '', '幸运大转盘关联的全局奖品id', 0, '', 219, 0, 1, 1395555085, 1395555085, '', 3, '', 'regex', '', 3, 'function'),
(1895, 'uid', '用户id', 'varchar(255) NOT NULL', 'string', '', '用户id', 0, '', 220, 0, 1, 1395567404, 1395567404, '', 3, '', 'regex', '', 3, 'function'),
(1896, 'xydzp_id', '幸运大转盘关联的活动id', 'int(10) UNSIGNED NOT NULL', 'num', '', '幸运大转盘关联的活动id', 0, '', 220, 0, 1, 1395567452, 1395567452, '', 3, '', 'regex', '', 3, 'function'),
(1897, 'num', '已经抽奖的次数', 'int(10) UNSIGNED NOT NULL', 'num', '0', '', 1, '', 220, 0, 1, 1395567486, 1395567486, '', 3, '', 'regex', '', 3, 'function'),
(1898, 'cjdate', '抽奖日期', 'int(10) NOT NULL', 'datetime', '', '', 1, '', 220, 0, 1, 1395567537, 1395567537, '', 3, '', 'regex', 'time', 3, 'function'),
(1899, 'show', '显示', 'char(10) NOT NULL', 'radio', '1', '', 1, '0:隐藏\r\n1:显示', 188, 0, 1, 1445678739, 1445678739, '', 3, '', 'regex', '', 3, 'function'),
(1900, 'note', '备注', 'text NOT NULL', 'textarea', '', '', 1, '', 184, 0, 1, 1445824754, 1445824754, '', 3, '', 'regex', '', 3, 'function'),
(1901, 'receiver', '收件人', 'varchar(255) NOT NULL', 'string', '', '', 1, '', 218, 0, 1, 1446192676, 1446192676, '', 3, '', 'regex', '', 3, 'function'),
(1902, 'share_time', '分享时间', 'int(10) NOT NULL', 'date', '', '', 1, '', 220, 0, 1, 1446192763, 1446192763, '', 3, '', 'regex', '', 3, 'function'),
(1903, 'share_count', '分享次数', 'int(10) NOT NULL', 'num', '', '', 1, '', 220, 0, 1, 1446192806, 1446192806, '', 3, '', 'regex', '', 3, 'function'),
(1920, 'return_msg', '状态', 'varchar(255) NOT NULL', 'string', '', '', 3, '', 222, 0, 1, 1447396459, 1447395664, '', 3, '', 'regex', '', 3, 'function'),
(1912, 're_openid', '发放对象', 'varchar(255) NOT NULL', 'string', '', '', 1, '', 222, 0, 1, 1447376704, 1447376704, '', 3, '', 'regex', '', 3, 'function'),
(1913, 'total_amount', '金额（分）', 'int(10) NOT NULL', 'num', '', '', 1, '', 222, 0, 1, 1447376733, 1447376733, '', 3, '', 'regex', '', 3, 'function'),
(1914, 'token', 'Token', 'varchar(255) NOT NULL', 'string', '', '', 0, '', 222, 0, 1, 1447385510, 1447376803, '', 3, '', 'regex', '', 3, 'function'),
(1915, 'send_time', '发放时间', 'int(10) NOT NULL', 'datetime', '', '', 3, '', 222, 0, 1, 1447398868, 1447376856, '', 3, '', 'regex', '', 3, 'function'),
(1916, 'act_name', '活动名称', 'varchar(255) NOT NULL', 'string', '', '', 1, '', 222, 0, 1, 1447385824, 1447376887, '', 3, '', 'regex', '', 3, 'function'),
(1917, 'wishing', '祝福语', 'varchar(255) NOT NULL', 'string', '', '', 1, '', 222, 0, 1, 1447385835, 1447376944, '', 3, '', 'regex', '', 3, 'function'),
(1918, 'remark', '备注', 'varchar(255) NOT NULL', 'textarea', '', '', 1, '', 222, 0, 1, 1447385587, 1447376964, '', 3, '', 'regex', '', 3, 'function'),
(1919, 'mid', '发放用户id', 'int(10) NOT NULL', 'num', '', '', 0, '', 222, 0, 1, 1447385519, 1447377021, '', 3, '', 'regex', '', 3, 'function'),
(1910, 'ptime', '提现时间', 'int(10) NOT NULL', 'datetime', '', '', 1, '', 179, 0, 1, 1446627819, 1446627819, '', 3, '', 'regex', '', 3, 'function'),
(1911, 'mch_billno', '商户单号', 'varchar(255) NOT NULL', 'string', '', '', 3, '', 222, 0, 1, 1447394898, 1447376604, '', 3, '', 'regex', '', 3, 'function');
...
(214, 'shop_seckill', '秒杀通过资格记录', 0, '', 1, '', '1:基础', '', '', '', '', '', 10, '', '', 1442397153, 1442397153, 1, 'MyISAM'),
...
(190, 'logistics', '物流', 0, '', 1, '{"1":["type","postid"]}', '1:基础', '', '', '', '', 'order_id:订单ID\r\nname:收件人\r\npostid:快递单号\r\ntype|get_name_by_status:快递公司\r\nlast_time:更新时间\r\nlast_state|get_name_by_status:状态\r\nid:操作:[EDIT]|编辑,[DELETE]|删除,more&id=[id]|详情', 10, 'order_id', 'order_id', 1439190551, 1444967528, 1, 'MyISAM'),
...
(89, 'follow', '粉丝管理', 0, '', 1, '{"1":["nickname","sex","headimgurl","city","province","country","language","mobile","score","experience"]}', '1:基础', '', '', '', '', 'id:粉丝编号\r\nopenid:OpenId\r\nnickname:昵称\r\nheadimgurl:头像\r\nsex|get_name_by_status:性别\r\nsubscribe_time|time_format:关注时间\r\nids:操作:[EDIT]|编辑,info&id=[id]|获取信息', 10, 'nickname', '', 1398845737, 1445043334, 1, 'MyISAM'),
...
(154, 'diy', '万能页面', 0, '', 1, '{"1":["keyword","title","cover","intro","is_close","need_login"]}', '1:基础', '', '', '', '', 'keyword:关键词\r\ntitle:标题\r\nis_close|get_name_by_status:是否关闭\r\nneed_login|get_name_by_status:游客访问\r\nview_count:浏览数\r\nid:操作:[EDIT]|编辑,del&id=[id]&_addons=Diy&_controller=Diy|删除,diy&id=[id]&target=_blank&_addons=Diy&_controller=Diy|排版,preview&id=[id]&target=_blank&_addons=Diy&_controller=Diy|预览,show&id=[id]&target=_blank&_addons=Diy&_controller=Diy&token=[token]|访问地址', 10, 'title', '', 1396061373, 1399105105, 1, 'MyISAM'),
(163, 'weixin_common_model', '微信插件常用模型', 0, '', 1, '{"1":["keyword","keyword_type","title","intro","cover","content"]}', '1:基础', '', '', '', '', 'keyword:关键词\r\nkeyword_type|get_name_by_status:关键词类型\r\ntitle:标题\r\ncTime|time_format:发布时间\r\nid:操作:[EDIT]|编辑,[DELETE]|删除', 10, 'title', '', 1396061373, 1396624744, 1, 'MyISAM'),
(166, 'wscsalesorder', '商品订单表', 0, '', 1, '{"1":["addr","name","odate","pcount","normalprice"]}', '1:基础', '', '', '', '', 'name:商品名\r\nnormalprice:单价\r\npcount:订购数量\r\nodate:下单时间\r\nid:操作:[EDIT]|编辑,[DELETE]|删除', 10, 'name', 'name', 1414136543, 1414466613, 1, 'MyISAM'),
(164, 'wscaddress', '收货地址', 0, '', 1, '', '1:基础', '', '', '', '', '', 10, '', '', 1414404068, 1414404068, 1, 'MyISAM'),
(165, 'wscproduct', '商品信息表', 0, '', 1, '{"1":["name","categoryid","litpic","price","normalprice","Recommend","desc","pdate"]}', '1:基础', '', '', '', '', 'id:编号\r\nname:商品名\r\nprice:原价\r\nnormalprice:出售价格\r\ncategoryid:商品类别\r\nid:操作:[EDIT]|编辑,[DELETE]|删除', 10, 'name', 'name', 1414120853, 1414143202, 1, 'MyISAM'),
(183, 'shop_settled', '已经结算订单', 1, '', 1, '', '1:基础', '', '', '', '', '', 10, '', '', 1438764550, 1438764550, 1, 'MyISAM'),
(184, 'shop_user', '微商用户', 0, '', 1, '{"1":["ctime","nickname","openid","token","address","phone","remain_money","user_cat","credit","profit_percentage","note"]}', '1:基础', '', '', '', '', 'id:会员ID\r\nwx_nickname:微信昵称\r\nheadimgurl:头像\r\nnickname:昵称\r\nopenid:openId\r\naddress:住址\r\nphone:电话\r\nuser_cat|get_name_by_status:用户分类\r\nremain_money:余额\r\nid:操作:[EDIT]|编辑,[DELETE]|删除,sell&openid=[openid]|分销关系', 10, 'wx_nickname', 'wx_nickname', 1437701471, 1445917186, 1, 'MyISAM'),
(189, 'shop_footer', '底部导航', 0, '', 1, '{"1":["pid","title","url","sort"]}', '1:基础', '', '', '', '', 'title:菜单名\r\nicon:图标\r\nurl:关联URL\r\nsort:排序号\r\nid:操作:[EDIT]|编辑,[DELETE]|删除', 10, 'title', '', 1394518309, 1396507698, 1, 'MyISAM'),
(181, 'shop_product_dis', '商品分销', 0, '', 1, '', '1:基础', '', '', '', '', '', 10, '', '', 1438868331, 1438868331, 1, 'MyISAM'),
(182, 'shop_return_order', '退货表', 0, '', 1, '{"1":["oid","reason","fee","token","status"]}', '1:基础', '', '', '', '', 'id:退货单id\r\noid:订货单id\r\nreason:退货理由\r\nfee:退费\r\nstatus|get_name_by_status:状态\r\nid:操作:agreeReturn&id=[id]|同意退款', 10, '', '', 1438876058, 1438938374, 1, 'MyISAM'),
(179, 'shop_get_cash', '用户取现', 0, '', 1, '{"1":["openid","fee","ctime","status","ptime"]}', '1:基础', '', '', '', '', 'id:ID\r\nwx_nickname:微信昵称\r\nopenid:openid\r\nheadimgurl:头像\r\nnickname:昵称\r\nuser_cat|get_name_by_status:用户分类\r\nctime|time_format:申请时间\r\nptime|time_format:通过时间\r\nfee:取现金额\r\nstatus|get_name_by_status:状态\r\nid:操作:changeStatus&id=[id]|提现', 10, '', '', 1438786223, 1447485240, 1, 'MyISAM'),
(178, 'shop_order', '微商店订单', 0, '', 1, '{"1":["order_status","timestamp","user_id","ip","total_fee","userinfo","title","count","fid","unit_price","pid","settle_status","receiver","address","phone","out_trade_no","token","express_fee","note"]}', '1:基础', '', '', '', '', 'id:ID\r\ntitle:商品名称\r\ntotal_fee:总费用\r\nnickname:下单人\r\ntimestamp:下单时间\r\nreceiver:收件人\r\nphone:电话\r\naddress:收件地址\r\norder_status|get_name_by_status:订单状态\r\nsettle_status|get_name_by_status:分销结算状态\r\nid:操作:[EDIT]|编辑,jumpLogistics&id=[id]|发货,jumpMore&id=[id]|快递详情,ziti&id=[id]|自提,more&id=[id]|详情', 10, 'title', 'title', 1437698180, 1444979991, 1, 'MyISAM'),
(175, 'shop_comments', '商品评价', 0, '', 1, '', '1:基础', '', '', '', '', '', 10, '', '', 1438246940, 1438246940, 1, 'MyISAM'),
(188, 'shop_product', '微商店商品', 0, '', 1, '{"1":["title","cover","intro","cate_id","market_price","discount_price","buy_url","ad_url","param","img_1","img_2","img_3","img_4","img_5","stock_price","first_deduct","second_deduct","third_deduct","express_fee","stock_count","is_limit","limit_count","express_fee_in_province","express_fee_out_province","shangjia"]}', '1:基础', '', '', '', '', 'id:商品ID\r\ncover|get_img_html:图片\r\ntitle:商品名称\r\ncate_id|getCommonCategoryTitle:分类\r\nmarket_price:市场价\r\ndiscount_price:售价\r\nview_count:浏览数\r\nshangjia:上架\r\nid:操作:[EDIT]|编辑,[DELETE]|删除,config&pid=[id]|分销管理', 10, 'title', '', 1396061373, 1441067409, 1, 'MyISAM'),
(177, 'shop_distribute', '商城分销', 0, '', 1, '{"1":["first_dis","second_dis","third_dis","openid","dis_sta"]}', '1:基础', '', '', '', '', 'id:分销id\r\nopenid:分销姓名\r\ndis_sta|get_name_by_status:类别\r\nfirst_dis:一级分销商\r\nsecond_dis:二级分销商\r\nthird_dis:三级分销商', 10, '', '', 1438673403, 1438749646, 1, 'MyISAM'),
(187, 'shop_pay_order_return', '微信支付返回信息', 0, '', 1, '', '1:基础', '', '', '', '', '', 10, '', '', 1439003473, 1439003473, 1, 'MyISAM'),
(191, 'hccard', '名片', 0, '', 1, '{"1":["company_addr","company_url","QQ","email","fax","post","tel","phone","portrait","ownername","company_name","info","wechat","description"]}', '1:基础', '', '', '', '', 'id:序号\r\nownername:姓名\r\nphone:手机\r\ntel:电话\r\nQQ:QQ\r\nid:操作:[EDIT]|编辑,[DELETE]|删除,show?id=[id]|预览', 10, 'ownername', '', 1439877406, 1440750565, 1, 'MyISAM'),
(192, 'hccard_link', '名片外链', 0, '', 1, '', '1:基础', '', '', '', '', '', 10, '', '', 1440379201, 1440379201, 1, 'MyISAM'),
(193, 'hccard_company', '公司介绍', 0, '', 1, '', '1:基础', '', '', '', '', '', 10, '', '', 1440378995, 1440378995, 1, 'MyISAM'),
(194, 'hccard_message', '名片留言', 0, '', 1, '', '1:基础', '', '', '', '', '', 10, '', '', 1440223564, 1440223564, 1, 'MyISAM'),
(213, 'forms_cjt_value', '报名数据', 0, '', 1, '', '1:基础', '', '', '', '', '', 10, '', '', 1396687959, 1396687959, 1, 'MyISAM'),
(206, 'vote', '投票', 0, '', 1, '{"1":["keyword","title","description","picurl","type","start_date","end_date"]}', '1:基础', '', '', '', '', 'id:投票ID\r\nkeyword:关键词\r\ntitle:投票标题\r\ntype|get_name_by_status:类型\r\nis_img|get_name_by_status:状态\r\nvote_count:投票数\r\nids:操作:show&id=[id]|预览,[EDIT]&id=[id]|编辑,[DELETE]|删除', 20, 'title', 'description', 1388930292, 1401017026, 1, 'MyISAM'),
(207, 'vote_option', '投票选项', 0, '', 1, '', '1:基础', '', '', '', '', '', 10, '', '', 1388933346, 1388933346, 1, 'MyISAM'),
(208, 'vote_log', '投票记录', 0, '', 1, '', '1:基础', '', '', '', '', '', 10, '', '', 1388934136, 1388934136, 1, 'MyISAM'),
(209, 'vote_forms', 'VoteCjt记录投票和表单的关系', 0, '', 1, '', '1:基础', '', '', '', '', '', 10, '', '', 1441098199, 1441098199, 1, 'MyISAM'),
(210, 'vote_option_link', '投票选项链接', 0, '', 1, '', '1:基础', '', '', '', '', '', 10, '', '', 1441095828, 1441095828, 1, 'MyISAM'),
(211, 'forms_cjt', '报名', 0, '', 1, '{"1":["keyword","keyword_type","title","intro","cover","can_edit","finish_tip","jump_url","content"]}', '1:基础', '', '', '', '', 'id:报名ID\r\nkeyword:关键词\r\nkeyword_type|get_name_by_status:关键词类型\r\ntitle:标题\r\ncTime|time_format:发布时间\r\nid:操作:[EDIT]|编辑,[DELETE]|删除,forms_cjt_attribute&id=[id]|字段管理,forms_cjt_value&id=[id]|数据管理,preview&id=[id]|预览', 10, 'title', '', 1396061373, 1401017094, 1, 'MyISAM'),
(212, 'forms_cjt_attribute', '表单字段', 0, '', 1, '{"1":["name","title","type","extra","value","remark","is_must","validate_rule","error_info","sort"]}', '1:基础', '', '', '', '', 'title:字段标题\r\nname:字段名\r\ntype|get_name_by_status:字段类型\r\nid:操作:[EDIT]&forms_cjt_id=[forms_cjt_id]|编辑,[DELETE]|删除', 10, 'title', '', 1396061373, 1396710959, 1, 'MyISAM'),
(216, 'xydzp', '幸运大转盘', 0, '', 1, '{"1":["keyword","title","start_date","end_date","picurl","guiz","des","des_jj","choujnum"]}', '1:基础', '', '', '', '', 'id:编号\r\nkeyword:触发关键词\r\ntitle:标题\r\nstart_date|time_format:开始时间\r\nend_date|time_format:结束日期\r\nchoujnum:每日抽奖次数\r\nid:操作:show?id=[id]|预览,zjloglists?id=[id]|中奖记录,jplists?xydzp_id=[id]|奖品设置,[EDIT]|编辑,[DELETE]|删除', 10, 'title', 'des', 1395395179, 1396703468, 1, 'MyISAM'),
(217, 'xydzp_option', '幸运大转盘奖品库设置', 0, '', 1, '{"1":["title","jptype","duijma","isdf","num","pic","miaoshu"]}', '1:基础', '', '', '', '', 'pic:奖品图片\r\ntitle:奖品名称\r\njptype:奖品类型\r\nnum:库存数量\r\nmiaoshu:奖品介绍\r\nid:操作:jpopedit?id=[id]|编辑,jpopdel?id=[id]|删除', 10, 'title', '', 1395395190, 1400990971, 1, 'MyISAM'),
(218, 'xydzp_log', '幸运大转盘中奖列表', 0, '', 1, '{"1":["xydzp_id","xydzp_option_id","zip","iphone","address","message","receiver","state"]}', '1:基础', '', '', '', '', 'id:编号\r\nusername:用户名称\r\nmobile:用户电话\r\ntitle:奖品名称\r\nreceiver:收件人\r\niphone:收件人电话\r\naddress:收货地址\r\nstate|get_name_by_status:领奖状态\r\nzjdate|time_format:中奖时间\r\nid:标记:ylingqu?id=[id]|已领取,wlingqu?id=[id]|未领取', 10, '', '', 1395395200, 1447224097, 1, 'MyISAM'),
(219, 'xydzp_jplist', '幸运大转盘奖品列表', 0, '', 1, '{"1":["type","gailv","gailv_str","gailv_maxnum","jlnum"]}', '1:基础', '', '', '', '', 'type:中奖方式\r\ngailv_str:中奖概率或参数\r\ngailv_maxnum:单日发放上限\r\njlnum:奖励数量\r\nid:操作:jpedit?id=[id]|编辑,jpdel?id=[id]|删除', 10, '', '', 1395554963, 1395921237, 1, 'MyISAM'),
(220, 'xydzp_userlog', '幸运大转盘用户抽奖记录', 0, '', 1, '', '1:基础', '', '', '', '', '', 10, '', '', 1395567366, 1395567366, 1, 'MyISAM'),
(222, 'red_paper', '红包', 0, '', 1, '{"1":["re_openid","total_amount","act_name","wishing","remark"]}', '1:基础', '', '', '', '', 'id:ID\r\nmch_billno:商户单号\r\nre_openid:收款openid\r\nwx_nickname:微信昵称\r\nheadimgurl:头像\r\nnickname:微分销昵称\r\ntotal_amount:金额（分）\r\nsend_time|time_format:发放时间\r\nremark:备注\r\nmid:发放用户\r\nreturn_msg:状态\r\nid:操作:[EDIT]|编辑,[DELETE]|删除', 10, '', '', 1447376499, 1447401345, 1, 'MyISAM');
...
CREATE TABLE IF NOT EXISTS `wp_forms_cjt` (
`id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '主键',
`jump_url`  varchar(255) NOT NULL  COMMENT '提交后跳转的地址',
`finish_tip`  text NOT NULL  COMMENT '用户提交后提示内容',
`cTime`  int(10) unsigned NOT NULL   COMMENT '发布时间',
...
CREATE TABLE IF NOT EXISTS `wp_forms_cjt_attribute` (
`id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '主键',
`sort`  int(10) unsigned NOT NULL   DEFAULT 0 COMMENT '排序号',
`extra`  text NOT NULL  COMMENT '参数',
`value`  varchar(255) NOT NULL  COMMENT '默认值',
...
`type`  char(50) NOT NULL  DEFAULT 'string' COMMENT '字段类型',
`title`  varchar(255) NOT NULL  COMMENT '字段标题',
`forms_cjt_id`  int(10) unsigned NOT NULL   COMMENT '表单ID',
`is_show`  tinyint(2) NOT NULL  DEFAULT 1 COMMENT '是否显示',
`error_info`  varchar(255) NOT NULL  COMMENT '出错提示',
`validate_rule`  varchar(255) NOT NULL  COMMENT '正则验证',
`is_must`  tinyint(2) NOT NULL  COMMENT '是否必填',
...
CREATE TABLE IF NOT EXISTS `wp_forms_cjt_value` (
`id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '主键',
`openid`  varchar(255) NOT NULL  COMMENT 'OpenId',
`cTime`  int(10) NOT NULL  COMMENT '增加时间',
`token`  varchar(255) NOT NULL  COMMENT 'Token',
...
CREATE TABLE IF NOT EXISTS `wp_logistics` (
`id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '主键',
`last_time`  char(19) NOT NULL  COMMENT '物流最后更新时间',
`type`  varchar(100) NOT NULL  COMMENT '快递公司',
`last_state`  int(1) NOT NULL  DEFAULT 0 COMMENT '物流最新状态',
`order_id`  int(32) NOT NULL  COMMENT '单号ID',
`postid`  varchar(255) NOT NULL  COMMENT '快递单号',
PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARACTER SET=utf8 COLLATE=utf8_general_ci CHECKSUM=0 ROW_FORMAT=DYNAMIC DELAY_KEY_WRITE=0;


CREATE TABLE IF NOT EXISTS `wp_red_paper` (
`id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '主键',
`return_msg`  varchar(255) NOT NULL  COMMENT '状态',
`re_openid`  varchar(255) NOT NULL  COMMENT '发放对象',
`total_amount`  int(10) NOT NULL  COMMENT '金额（分）',
`token`  varchar(255) NOT NULL  COMMENT 'Token',
`send_time`  int(10) NOT NULL  COMMENT '发放时间',
`act_name`  varchar(255) NOT NULL  COMMENT '活动名称',
`wishing`  varchar(255) NOT NULL  COMMENT '祝福语',
`remark`  varchar(255) NOT NULL  COMMENT '备注',
`mid`  int(10) NOT NULL  COMMENT '发放用户id',
`mch_billno`  varchar(255) NOT NULL  COMMENT '商户单号',
PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARACTER SET=utf8 COLLATE=utf8_general_ci CHECKSUM=0 ROW_FORMAT=DYNAMIC DELAY_KEY_WRITE=0;
...
CREATE TABLE IF NOT EXISTS `wp_shop_distribute` (
`id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '主键',
`f_openid`  varchar(255) NOT NULL  COMMENT '上线openid',
`token`  varchar(255) NOT NULL  COMMENT 'token',
`manager_openid`  varchar(255) NOT NULL  COMMENT '一级分销',
`openid`  varchar(255) NOT NULL  COMMENT '任何用户的openid',
`seller_openid`  varchar(255) NOT NULL  COMMENT '二级分销',
PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARACTER SET=utf8 COLLATE=utf8_general_ci CHECKSUM=0 ROW_FORMAT=DYNAMIC DELAY_KEY_WRITE=0;
CREATE TABLE IF NOT EXISTS `wp_shop_get_cash` (
`id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '主键',
`status`  int(50) NOT NULL  DEFAULT 0 COMMENT '状态',
`ctime`  int(10) NOT NULL  COMMENT '申请取现时间',
`fee`  int(10) NOT NULL  COMMENT '取现金额（分）',
`openid`  varchar(255) NOT NULL  COMMENT 'openid',
`ptime`  int(10) NOT NULL  COMMENT '提现时间',
PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARACTER SET=utf8 COLLATE=utf8_general_ci CHECKSUM=0 ROW_FORMAT=DYNAMIC DELAY_KEY_WRITE=0;
...
`by_from_openid`  varchar(255) NOT NULL  COMMENT '购买的上线openid',
`settle_status`  int(50) NOT NULL  DEFAULT 0 COMMENT '分销结算状态',
...
`title`  varchar(255) NOT NULL  COMMENT '商品名称',
`out_trade_no`  varchar(255) NOT NULL  COMMENT '商户支付订单号',
`token`  varchar(255) NOT NULL  COMMENT 'token',
`express_fee`  int(10) NOT NULL  COMMENT '快递费',
`note`  text NOT NULL  COMMENT '备注',
PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARACTER SET=utf8 COLLATE=utf8_general_ci CHECKSUM=0 ROW_FORMAT=DYNAMIC DELAY_KEY_WRITE=0;
CREATE TABLE IF NOT EXISTS `wp_shop_pay_order_return` (
`id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '主键',
`return_code`  varchar(255) NOT NULL  COMMENT '返回状态码',
`return_msg`  varchar(255) NOT NULL  COMMENT '返回信息',
`appid`  varchar(255) NOT NULL  COMMENT 'apppid',
`mch_id`  varchar(255) NOT NULL  COMMENT '商户号',
`nonce_str`  varchar(255) NOT NULL  COMMENT '随机字符串',
`sign`  varchar(255) NOT NULL  COMMENT '签名',
`is_subscribe`  varchar(255) NOT NULL  COMMENT '是否关注公众号',
`trade_type`  varchar(255) NOT NULL  COMMENT '交易类型',
`trade_state`  varchar(255) NOT NULL  COMMENT '交易状态',
`bank_type`  varchar(255) NOT NULL  COMMENT '付款银行',
`total_fee`  int(10) NOT NULL  COMMENT '总金额',
`cash_fee`  int(10) NOT NULL  COMMENT '现金支付金额',
`fee_type`  varchar(255) NOT NULL  COMMENT '现金支付货币类型',
`coupon_fee`  int(10) NOT NULL  COMMENT '代金券或立减优惠金额',
`coupon_count`  int(10) NOT NULL  COMMENT '代金券或立减优惠使用数量',
`transaction_id`  varchar(255) NOT NULL  COMMENT '微信支付订单号',
`out_trade_no`  varchar(255) NOT NULL  COMMENT '商户订单号',
`time_end`  varchar(255) NOT NULL  COMMENT '支付完成时间',
`trade_state_desc`  varchar(255) NOT NULL  COMMENT '交易状态描述',
`result_code`  varchar(255) NOT NULL  COMMENT '业务结果',
`openid`  varchar(255) NOT NULL  COMMENT 'openid',
`attach`  text NOT NULL  COMMENT '',
PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARACTER SET=utf8 COLLATE=utf8_general_ci CHECKSUM=0 ROW_FORMAT=DYNAMIC DELAY_KEY_WRITE=0;
...
`cate_id`  char(50) NOT NULL  COMMENT '商品分类',
`bug_count`  int(10) unsigned NOT NULL   DEFAULT 0 COMMENT '成交量',
`stock_price`  int(10) NOT NULL  COMMENT '进货价',
`first_deduct`  int(10) NOT NULL  COMMENT '一级代理提成',
`second_deduct`  int(10) NOT NULL  COMMENT '二级代理提成',
`third_deduct`  int(10) NOT NULL  COMMENT '三级代理提成',
`img_5`  int(10) unsigned NOT NULL   COMMENT '商品图片5',
`img_4`  int(10) unsigned NOT NULL   COMMENT '商品图片4',
`view_count`  int(10) unsigned NOT NULL   DEFAULT 0 COMMENT '浏览数',
`img_3`  int(10) unsigned NOT NULL   COMMENT '商品图片3',
...
`img_2`  int(10) unsigned NOT NULL   COMMENT '商品图片2',
`express_fee`  int(10) NOT NULL  COMMENT '快递费',
`stock_count`  int(10) NOT NULL  COMMENT '库存',
`is_limit`  char(50) NOT NULL  DEFAULT 0 COMMENT '限购',
`limit_count`  int(10) NOT NULL  DEFAULT 1 COMMENT '限购数量',
`express_fee_in_province`  int(10) NOT NULL  COMMENT '省内快递费',
`express_fee_out_province`  int(10) NOT NULL  COMMENT '省外快递费',
`shangjia`  char(10) NOT NULL  DEFAULT '下架' COMMENT '上架',
`exchange`  int(10) NOT NULL  DEFAULT 0 COMMENT '积分兑换',
`score`  int(10) NOT NULL  DEFAULT 0 COMMENT '财富值',
`experience`  int(10) NOT NULL  DEFAULT 0 COMMENT '经验值',
`show`  char(10) NOT NULL  DEFAULT 1 COMMENT '显示',
PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARACTER SET=utf8 COLLATE=utf8_general_ci CHECKSUM=0 ROW_FORMAT=DYNAMIC DELAY_KEY_WRITE=0;
CREATE TABLE IF NOT EXISTS `wp_shop_product_dis` (
`id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '主键',
`manager_deduct`  varchar(255) NOT NULL  COMMENT '经理提成',
`partner_deduct`  varchar(255) NOT NULL  COMMENT '合伙人总提成',
`token`  varchar(255) NOT NULL  COMMENT 'token',
`seller_credit`  int(10) NOT NULL  COMMENT '销售员积分',
`manager_credit`  varchar(255) NOT NULL  COMMENT '经理积分',
`partner_credict`  varchar(255) NOT NULL  COMMENT '合伙人积分',
`seller_deduct`  varchar(255) NOT NULL  COMMENT '销售员提成',
`pid`  int(10) NOT NULL  COMMENT '商品id',
PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARACTER SET=utf8 COLLATE=utf8_general_ci CHECKSUM=0 ROW_FORMAT=DYNAMIC DELAY_KEY_WRITE=0;
CREATE TABLE IF NOT EXISTS `wp_shop_return_order` (
`id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '主键',
`token`  varchar(255) NOT NULL  COMMENT 'token',
`fee`  int(10) NOT NULL  COMMENT '费用',
`reason`  int(10) NOT NULL  COMMENT '退货理由',
`oid`  int(10) NOT NULL  COMMENT '订单id',
`status`  int(10) NOT NULL  DEFAULT 2 COMMENT '退单状态',
PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARACTER SET=utf8 COLLATE=utf8_general_ci CHECKSUM=0 ROW_FORMAT=DYNAMIC DELAY_KEY_WRITE=0;
CREATE TABLE IF NOT EXISTS `wp_shop_seckill` (
`id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '主键',
`openid`  varchar(255) NOT NULL  COMMENT 'openid',
`ctime`  int(10) NOT NULL  COMMENT '创建时间',
`token`  varchar(255) NOT NULL  COMMENT 'token',
`pid`  int(10) NOT NULL  COMMENT '商品ID',
`used`  tinyint(2) NOT NULL  DEFAULT 0 COMMENT '已使用',
PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARACTER SET=utf8 COLLATE=utf8_general_ci CHECKSUM=0 ROW_FORMAT=DYNAMIC DELAY_KEY_WRITE=0;
...
CREATE TABLE IF NOT EXISTS `wp_weixin_common_model` (
`id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '主键',
`keyword`  varchar(100) NOT NULL  COMMENT '关键词',
`keyword_type`  tinyint(2) NOT NULL  DEFAULT 0 COMMENT '关键词类型',
`title`  varchar(255) NOT NULL  COMMENT '标题',
